...
public class KettleJDBCPreparedStatement extends KettleJDBCStatement implements PreparedStatement {
  ConnectionJDBC3 connection;
  String sql;
  String url;
  private final transient Log log = LogFactory.getLog( KettleJDBCPreparedStatement.class );

  public KettleJDBCPreparedStatement( ConnectionJDBC3 connection, String sql, String url ) {
