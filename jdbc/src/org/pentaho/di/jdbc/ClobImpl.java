...
public class ClobImpl implements Clob {
  ...
  /**
   * 0 length <code>String</code> as initial value for empty <code>Clob</code>s.
   */
   ...
   *          a reference to the parent connection object
   * @param str
   *          the <code>String</code> object to encapsulate
   */
  ...
  public Reader getCharacterStream() throws SQLException {
    try {
      return new BufferedReader( new InputStreamReader( blobBuffer.getBinaryStream( false ), "UTF-16LE" ) );
    } catch ( UnsupportedEncodingException e ) {
      // This should never happen!
      throw new IllegalStateException( "UTF-16LE encoding is not supported." );
    }
  ...
  public long position( String searchStr, long start ) throws SQLException {
    if ( searchStr == null ) {
      throw new SQLException( BaseMessages.getString( PKG, "error.clob.searchnull" ), "HY009" );
    }
    try {
  ...
  public Writer setCharacterStream( final long pos ) throws SQLException {
    try {
      return new BufferedWriter( new OutputStreamWriter( blobBuffer.setBinaryStream( ( pos - 1 ) * 2 + 1, false ),
          "UTF-16LE" ) );
    } catch ( UnsupportedEncodingException e ) {
      // Should never happen
      throw new IllegalStateException( "UTF-16LE encoding is not supported." );
  ...
  public int setString( long pos, String str ) throws SQLException {
    if ( str == null ) {
      throw new SQLException( BaseMessages.getString( PKG, "error.clob.strnull" ), "HY009" );
    }
