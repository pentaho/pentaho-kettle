...
public class KettleJDBCStatement implements Statement {
  ...
  public boolean execute( String sql ) throws SQLException {
    ...
    try {
      ...
      String kettleurl =
          this.url.substring( url.indexOf( KettleDriver.driverPrefix ) + KettleDriver.driverPrefix.length() );
  ...
  protected void checkOpen() throws SQLException {
    if ( closed || connection == null || connection.isClosed() ) {
      throw new SQLException( BaseMessages.getString( PKG, "error.generic.closed", "Statement" ), "HY010" );
    }
  }
