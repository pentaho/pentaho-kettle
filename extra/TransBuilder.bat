...
set CLASSPATH=%CLASSPATH%;%BASEDIR%\libext\firebirdsql-full.jar
set CLASSPATH=%CLASSPATH%;%BASEDIR%\libext\firebirdsql.jar
set CLASSPATH=%CLASSPATH%;%BASEDIR%\libext\gis-shape.jar
...
set CLASSPATH=%CLASSPATH%;%BASEDIR%\libext\jconn2.jar
...
set CLASSPATH=%CLASSPATH%;%BASEDIR%\libext\ktable.jar
