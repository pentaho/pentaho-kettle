...
public class SpoonTransformationBrowserTest {
  ...
  public void testIsBrowserVisibleTransGraph() {
    ...
    Boolean result = SpoonTransformationBrowser.isBrowserVisible( transGraphMock );
    assertFalse( result );
    children = new Control[] { browser, control1, control2 };
    when( transGraphMock.getChildren() ).thenReturn( children );
    result = SpoonTransformationBrowser.isBrowserVisible( transGraphMock );
    assertTrue( result );
  }
  ...
  public void testShowTransformationBrowserh() {
    ...
    Control[] children = new Control[] { control1, control2, browser };
    when( transGraphMock.getChildren() ).thenReturn( children );
    SpoonTransformationBrowser.showTransformationBrowser( transGraphMock );
  }
  ...
  public void testGetTransformationBrowserForTransGraph() {
    ...
    when( transGraphMock.getChildren() ).thenReturn( children );
    Browser browser = SpoonTransformationBrowser.getTransformationBrowserForTransGraph( transGraphMock );
  ...
  public void testHideTransformationBrowser() {
    ...
    Control[] children = new Control[] { control1, control2, browser };
    when( transGraphMock.getChildren() ).thenReturn( children );
    SpoonTransformationBrowser.hideTransformationBrowser( transGraphMock );
  }
}
