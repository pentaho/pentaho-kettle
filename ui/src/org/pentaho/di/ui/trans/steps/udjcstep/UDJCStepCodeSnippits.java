...
public class UDJCStepCodeSnippits {
	private static Class<?>							PKG				= UserDefinedJavaClass.class;
	private static UDJCStepCodeSnippits	snippitsHelper	= null;
	...
	public static synchronized UDJCStepCodeSnippits getSnippitsHelper() throws KettleXMLException {
		if (snippitsHelper == null) {
			snippitsHelper = new UDJCStepCodeSnippits();
			snippitsHelper.addSnippits("codeSnippits.xml");
		}
		return snippitsHelper;
	}

	private UDJCStepCodeSnippits() {}

	public void addSnippits(String strFileName) throws KettleXMLException {
		Document doc = XMLHandler.loadXMLFile(UDJCStepCodeSnippits.class.getResourceAsStream(strFileName),
						null, false, false);
