...
public class SimpleMappingDialog extends BaseStepDialog implements StepDialogInterface
{
  ...
  private void selectRepositoryTrans()
	{
		...
		} catch (KettleException ke)
		{
			new ErrorDialog(
					shell,
					BaseMessages.getString(PKG, "SimpleMappingDialog.ErrorSelectingObject.DialogTitle"), BaseMessages.getString(PKG, "SimpleMappingDialog.ErrorSelectingObject.DialogMessage"), ke);  
		}
	}
  ...
  private void getByReferenceData(ObjectId transObjectId) {
    try {
      ...
      new ErrorDialog(shell, 
          BaseMessages.getString(PKG, "SimpleMappingDialog.Exception.UnableToReferenceObjectId.Title"), 
          BaseMessages.getString(PKG, "SimpleMappingDialog.Exception.UnableToReferenceObjectId.Message"), e);
    }
  }
  ...
  public void getData() {
	...
	private void addOutputMappingDefinitionTab(MappingIODefinition definition, int index)
	{
		addMappingDefinitionTab(definition, index + 1, 
				...
				BaseMessages.getString(PKG, "SimpleMappingDialog.OutputTab.column.TargetField"), false);
	}

	private void addInputMappingDefinitionTab(MappingIODefinition definition, int index)
	{
		addMappingDefinitionTab(definition, index + 1, BaseMessages.getString(PKG, "SimpleMappingDialog.InputTab.Title"),
				...
				BaseMessages.getString(PKG, "SimpleMappingDialog.InputTab.column.TargetField"), true);
	}
	...
	private void addParametersTab(final MappingParameters parameters)
	{
		...
		ColumnInfo[] colinfo = new ColumnInfo[] {
				new ColumnInfo(
						BaseMessages.getString(PKG, "SimpleMappingDialog.Parameters.column.Variable"), ColumnInfo.COLUMN_TYPE_TEXT, false, false), 
				new ColumnInfo(
						BaseMessages.getString(PKG, "SimpleMappingDialog.Parameters.column.ValueOrField"), ColumnInfo.COLUMN_TYPE_TEXT, false, false), 
		};
	...
	private void addMappingDefinitionTab(final MappingIODefinition definition, int index,
			final String tabTitle, final String tabTooltip, String sourceColumnLabel, String targetColumnLabel, final boolean input)
	{
	...
	private void ok()
	{
		...
		{
			new ErrorDialog(shell, BaseMessages.getString(PKG, "SimpleMappingDialog.ErrorLoadingSpecifiedTransformation.Title"), 
			    BaseMessages.getString(PKG, "SimpleMappingDialog.ErrorLoadingSpecifiedTransformation.Message"), e);
		}
