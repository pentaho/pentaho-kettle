...
public class SalesforceInsertDialog extends BaseStepDialog implements StepDialogInterface {
  ...
  public String open() {
    ...
    wURL =
        new LabelTextVar(
            transMeta, wConnectionGroup, BaseMessages.getString( PKG, "SalesforceInsertDialog.URL.Label" ),
    ...
    wUserName =
        new LabelTextVar( transMeta, wConnectionGroup, BaseMessages
            .getString( PKG, "SalesforceInsertDialog.User.Label" ), BaseMessages.getString(
  ...
  private void getUpdate() {
    try {
      ...
      new ErrorDialog(
          shell, BaseMessages.getString( PKG, "SalesforceInsertDialog.FailedToGetFields.DialogTitle" ), BaseMessages
              .getString( PKG, "SalesforceInsertDialog.FailedToGetFields.DialogMessage" ), ke );
    }
  }
  ...
  private void test() {
    ...
    if ( successConnection ) {
      ...
      new ErrorDialog(
          shell, BaseMessages.getString( PKG, "SalesforceInsertDialog.Connected.Title.Error" ), BaseMessages.getString(
              PKG, "SalesforceInsertDialog.Connected.NOK", wUserName.getText() ), new Exception( msgError ) );
    }
  ...
  private void ok() {
    try {
      ...
      new ErrorDialog(
          shell, BaseMessages.getString( PKG, "SalesforceInsertDialog.ErrorValidateData.DialogTitle" ), BaseMessages
              .getString( PKG, "SalesforceInsertDialog.ErrorValidateData.DialogMessage" ), e );
    }
  ...
  private void getModulesList() {
    if ( !gotModule ) {
      ...
      try {
        ...
        new ErrorDialog(
            shell, BaseMessages.getString( PKG, "SalesforceInsertDialog.ErrorRetrieveModules.DialogTitle" ),
