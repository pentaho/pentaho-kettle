...
public class OlapInputDialog extends BaseStepDialog implements
		StepDialogInterface {
	...
	public OlapInputDialog(Shell parent, Object in, TransMeta transMeta,
			String sname) {
	...
	public String open() {
		...
		wUsername = new TextVar(transMeta, shell, SWT.SINGLE | SWT.LEFT
				| SWT.BORDER);
		...
		wPassword = new TextVar(transMeta, shell, SWT.SINGLE | SWT.LEFT
				| SWT.BORDER);
		...
		wCatalog = new TextVar(transMeta, shell, SWT.SINGLE | SWT.LEFT
				| SWT.BORDER);
...
//		fdAscLink.top = new FormAttachment();
		...
		this.wAscLink.setText(BaseMessages.getString(PKG,
				"OlapInputDialog.Provided.Info"));
	...
	public void setPosition() {
		...
		wlPosition.setText(BaseMessages.getString(PKG,
				"OlapInputDialog.Position.Label", "" + linenr, "" + colnr));
	...
	protected void setSQLToolTip() {
		if (wVariables.getSelection())
			wMDX
					.setToolTipText(transMeta.environmentSubstitute(wMDX
							.getText()));
	}
