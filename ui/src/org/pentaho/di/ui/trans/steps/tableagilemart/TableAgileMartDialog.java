...
public class TableAgileMartDialog extends BaseStepDialog implements StepDialogInterface
{
	...
	public String open()
	{
		...
		shell.setText(BaseMessages.getString(PKG, "TableAgileMartDialog.Shell.Title")); //$NON-NLS-1$
		...
		wlStepname.setText(BaseMessages.getString(PKG, "TableAgileMartDialog.Stepname.Label")); //$NON-NLS-1$
