 ...
 * @since 17-04-2004
 */
public class OldTableDraw extends Canvas {
  ...
  public OldTableDraw( Composite parent, PropsUI props, WizardPage wPage, Vector<TextFileInputFieldInterface> fields ) {
    ...
    addPaintListener( new PaintListener() {
      public void paintControl( PaintEvent e ) {
        OldTableDraw.this.paintControl( e );
      }
    } );
