...
public class ClusterSchemaDialog extends Dialog {
  ...
  public boolean open() {
    ...
    ColumnInfo[] partitionColumns =
        new ColumnInfo[] {
            new ColumnInfo(
                BaseMessages.getString( PKG, "ClusterSchemaDialog.ColumnInfoName.Label" ), ColumnInfo.COLUMN_TYPE_TEXT,
                true, false ),
            new ColumnInfo(
  ...
  private void selectSlaveServers() {
    ...
    EnterSelectionDialog dialog =
        new EnterSelectionDialog(
            shell, names, BaseMessages.getString( PKG, "ClusterSchemaDialog.SelectServers.Label" ), BaseMessages
                .getString( PKG, "ClusterSchemaDialog.SelectServersCluster.Label" ) );
