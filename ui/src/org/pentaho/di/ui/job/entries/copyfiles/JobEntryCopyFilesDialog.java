    ...
    if ( jobEntry.source_filefolder != null ) {
      for ( int i = 0; i < jobEntry.source_filefolder.length; i++ ) {
        ...
        if ( jobEntry.source_filefolder[i] != null ) {
          ...
          String clusterName1 = jobEntry.getConfigurationBy( sourceUrl );
          if ( clusterName1 != null ) {
            clusterName1 =
                clusterName1.startsWith( JobEntryCopyFiles.LOCAL_SOURCE_FILE ) ? LOCAL_ENVIRONMENT : clusterName1;
            clusterName1 =
                clusterName1.startsWith( JobEntryCopyFiles.STATIC_SOURCE_FILE ) ? STATIC_ENVIRONMENT : clusterName1;

            ti.setText( 1, clusterName1 );
            sourceUrl =
                clusterName1.equals( LOCAL_ENVIRONMENT ) || clusterName1.equals( STATIC_ENVIRONMENT ) ? sourceUrl
