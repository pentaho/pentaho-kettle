...
/**
 * A class to manage breadcrumbing so that we know which document/tab/perspective opened a 
 * given document.
 * @author jamesdixon
 *
 */
public class BreadcrumbManager {
	   ...
	   */
	    ...
	    /**
	     * Returns the id of the caller for a given callee id. Will return null
	     * if there is no caller registered for the callee id.
	     * @param callee
	     * @return
	     */
