...
public final class SpoonTransformationBrowser {

  private static int[] savedSashWeights;

  private SpoonTransformationBrowser() {
    super();
  }
  ...
  public static boolean isBrowserVisible() {
    return isBrowserVisible( Spoon.getInstance().getActiveTransGraph() );
  }
   ...
   */
  public static boolean isBrowserVisible( TransGraph graph ) {
    return graph.getChildren()[0] instanceof Browser;
  }

  /**
   * createTransformationBrowser
   * 
   * creates a web browser for the current TransGraph
   */
  public static void createTransformationBrowser() {
    createTransformationBrowser( Spoon.getInstance().getActiveTransGraph() );
  }

  /**
   * createDataBrowser( TransGraph parent )
   * 
   ...
   */
  public static void createTransformationBrowser( TransGraph parent ) {
    if ( parent == null ) {
      return;
    }
   ...
   */
  public static void showTransformationBrowser() {
    showTransformationBrowser( Spoon.getInstance().getActiveTransGraph() );
  }

  /**
   * showTransformationBrowser( TransGraph graph )
   * 
   * @param graph
   ...
   */
  public static void showTransformationBrowser( TransGraph graph ) {
    if ( graph == null ) {
      return;
    }
    Browser browser = getTransformationBrowserForTransGraph( graph );
    if ( browser == null ) {
      createTransformationBrowser();
      browser = getTransformationBrowserForTransGraph( graph );
      if ( browser == null ) {
        return;
      }
    }
    maximizeTransformationBrowser( browser );
  ...
  /**
   * getCurrentTransformationBrowser
   * 
   * @return a browser for the current active TransGraph (if it has been created).
   */
  public static Browser getCurrentTransformationBrowser() {
    return getTransformationBrowserForTransGraph( Spoon.getInstance().getActiveTransGraph() );
  }

  /**
   * getTransformationBrowserForTransGraph
   * 
   * @param graph
   ...
   */
  public static Browser getTransformationBrowserForTransGraph( TransGraph graph ) {
  ...
  /**
   * hideTransformationBrowser
   * 
   * hides the web browser associated with the active TransGraph
   */
  public static void hideTransformationBrowser() {
    hideTransformationBrowser( Spoon.getInstance().getActiveTransGraph() );
  }

  /**
   * hideTransformationBrowser( TransGraph graph )
   * 
   * @param graph
   *          the TransGraph whose web browser will be hidden
   */
  public static void hideTransformationBrowser( TransGraph graph ) {
    Browser browser = getTransformationBrowserForTransGraph( graph );
    if ( browser == null ) {
      return;
    }
   ...
   */
  public static void maximizeTransformationBrowser( Browser browser ) {
    SashForm sash = (SashForm) browser.getParent().getParent().getParent().getParent();
