...
/**
 * This class contains and handles all the translations for the keys specified
...
public class TranslationsStore {
  ...
  /**
   * Read all the translated messages for all the specified locale and all the
   * specified locale
   * 
   * @param directories
   ...
   * @param key
   *          the key
   * @return the translation for the specified key in the desired locale, from
   ...
   * @param messagesPackage
   *          the messagesPackage to filter on. Specify null to get all message
   *          stores.
