...
public class TextFileOutputLegacyDialog extends TextFileOutputDialog {
  ...
  protected Control addAdditionalComponentIfNeed( int middle, int margin, Composite wFileComp, Composite topComp ) {
    ...
    wlFileIsCommand
      .setText( BaseMessages.getString( textFileOutputLegacyMetaClass, "TextFileOutputDialog.FileIsCommand.Label" ) );
  ...
  protected String getDialogTitle() {
    return BaseMessages.getString( textFileOutputLegacyMetaClass, "TextFileOutputDialog.DialogTitle" );
  }
