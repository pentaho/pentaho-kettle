 ...
 *
 *   Group group = template.group(shell, controlAbove, "title")
 *   Combo text = template.text(group, "initial text", template.label(group, "label text", null))
 */
...
public class WidgetBuilder<T extends Control> {
  ...
  public WidgetBuilder<T> below( Control controlAbove, int margin ) {
    formDataBuilder.top( controlAbove, margin );
    return this;
  }

  public WidgetBuilder<T> rightOf( Control controlToLeft, int margin ) {
    formDataBuilder.left( controlToLeft, margin );
    return this;
  }
  ...
  public static class Templates {
    ...
    public Label label( Composite composite, String text, Control above ) {
    ...
    public Label separator( Composite composite, Control above ) {
      return new WidgetBuilder<Label>()
        .container( composite )
    ...
    public Label image( Composite container, Image image ) {
      return new WidgetBuilder<Label>()
        .container( container )
        .image( image )
        .style( SWT.RIGHT )
    ...
    public Text text( Composite composite, String text, Control above ) {
    ...
    public ComboVar combo( Composite composite, Control left, Control above, String... items ) {
    ...
    public Button button( Composite composite, String text, Control above, int style ) {
    ...
    public Group group( Composite composite, Control above, String text ) {
