...
def getJobParameters(String buildJobName) {
  ...
  List parameterNames = [
    ...
    'RUN_STAGE_BUILD', 'RUN_STAGE_CHECKOUT', 'RUN_STAGE_VERSION', 'RUN_STAGE_TEST', 'RUN_STAGE_ARCHIVE', 'CREATE_TAG',
    'PARALLEL_CHUNKSIZE', 'PARALLEL_CHECKOUT_CHUNKSIZE', 'PARALLEL_PUSH_CHUNKSIZE', 'PARALLEL_TAG_CHUNKSIZE', 
    'PARALLEL_UNIT_TESTS_CHUNKSIZE', 'PARALLEL_SECURITY_SCAN_CHUNKSIZE', 'PARALLEL_ARCHIVING_CHUNKSIZE',
