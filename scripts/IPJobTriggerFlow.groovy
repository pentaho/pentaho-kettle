...
if (isQAT) {
  allowRunIPJobs = ((suiteReleaseVersion.equals("9.4-QAT") && Boolean.parseBoolean(params.DO_94_QAT_SCAN))
  ...
  allowRunIPJobs = ((suiteReleaseVersion.startsWith("9.4") && Boolean.parseBoolean(params.DO_94_R_SCAN))
