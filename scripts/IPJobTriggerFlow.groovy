...
if (isQAT) {
  allowRunIPJobs = ((suiteReleaseVersion.equals("9.6-QAT") && Boolean.parseBoolean(params.DO_96_QAT_SCAN))
    || (suiteReleaseVersion.equals("9.5-QAT") && Boolean.parseBoolean(params.DO_95_QAT_SCAN))
    || (suiteReleaseVersion.equals("9.3-QAT") && Boolean.parseBoolean(params.DO_93_QAT_SCAN))
  ...
  allowRunIPJobs = ((suiteReleaseVersion.startsWith("9.6") && Boolean.parseBoolean(params.DO_96_R_SCAN))
    || (suiteReleaseVersion.startsWith("9.5") && Boolean.parseBoolean(params.DO_95_R_SCAN))
    || (suiteReleaseVersion.startsWith("9.3") && Boolean.parseBoolean(params.DO_93_R_SCAN))
