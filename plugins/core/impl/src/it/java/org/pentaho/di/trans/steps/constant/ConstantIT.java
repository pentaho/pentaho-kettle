...
public class ConstantIT {
  ...
  public static void init() throws Exception {
    ...
    StepPluginType.getInstance().handlePluginAnnotation( ConstantMeta.class,
      ConstantMeta.class.getAnnotation( Step.class ), Collections.<String> emptyList(), false, null );
  }
