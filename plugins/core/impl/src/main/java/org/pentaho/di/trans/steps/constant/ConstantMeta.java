 ...
 *
 */
@Step( id = "Constant", i18nPackageName = "org.pentaho.di.trans.steps.constant", name = "Constant.Name",
  description = "Constant.Description", categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.Transform" )
