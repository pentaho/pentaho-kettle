...
public class GPLoadTests {
   ...
   * 
   * @param filename
   * @return String the content of filename which is located in GPLoadTests.YAML_TEST_FILE_LOCATION.
   */
  ...
  private GPLoadMeta createGPLoadMeta( String gpLoadStepname, String action, String targetTableName,
    ...
    return createGPLoadMeta( gpLoadStepname, action, null, targetTableName,
            errorTableName, dataFilename, delimiter,
        null, null, null, tableColumn, matchColumn,
            updateColumn, localhostPort, localHosts, updateCondition, encoding );
  }
  ...
  public void testInsert1() throws Exception {
    ...
    GPLoadMeta gpLoadMeta =
        createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_INSERT, GPLoadTests.TARGET_TABLE,
            GPLoadTests.GPLOAD_ERROR_TABLE, GPLoadTests.INSERT_DATA_FILE, ";", new String[0], new boolean[0],
  ...
  public void testSchemaNameSpecified() throws Exception {
    ...
    // and specifying to columns
    GPLoadMeta gpLoadMeta =
        createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_INSERT, GPLoadTests.SCHEMA_NAME, GPLoadTests.TARGET_TABLE,
            GPLoadTests.GPLOAD_ERROR_TABLE, GPLoadTests.INSERT_DATA_FILE, ";", new String[0], new boolean[0],
            new boolean[0], null, null, // no local host port or localhosts
            null, null );
  ...
  public void testUpdate1() throws Exception {
    ...
    // and specifying to columns
    GPLoadMeta gpLoadMeta =
        createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_UPDATE, GPLoadTests.TARGET_TABLE,
            GPLoadTests.GPLOAD_ERROR_TABLE, GPLoadTests.UPDATE_DATA_FILE, ";", TABLE_FIELD, matchColumn, updateColumn,
  ...
  public void testUpdate2() throws Exception {
    ...
    GPLoadMeta gpLoadMeta =
        createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_UPDATE, GPLoadTests.TARGET_TABLE,
            GPLoadTests.GPLOAD_ERROR_TABLE, GPLoadTests.UPDATE_DATA_FILE, ",", TABLE_FIELD, null, updateColumn, null,
  ...
  public void testUpdate3() throws Exception {
    ...
    GPLoadMeta gpLoadMeta =
        createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_UPDATE, GPLoadTests.TARGET_TABLE,
            GPLoadTests.GPLOAD_ERROR_TABLE, GPLoadTests.UPDATE_DATA_FILE, ",", TABLE_FIELD, matchColumn, null, null,
            null, // no local host port or localhosts);
            null, null );
  ...
  public void testUpdate4() throws Exception {
    ...
    GPLoadMeta gpLoadMeta =
        createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_UPDATE, GPLoadTests.TARGET_TABLE,
            GPLoadTests.GPLOAD_ERROR_TABLE, GPLoadTests.UPDATE_DATA_FILE,
  ...
  public void testUpdate6() throws Exception {
    ...
    // and specifying to columns
    GPLoadMeta gpLoadMeta =
        createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_UPDATE, null, GPLoadTests.GPLOAD_ERROR_TABLE,
            GPLoadTests.UPDATE_DATA_FILE, ";", TABLE_FIELD, matchColumn, updateColumn, null, null, // no local host port
                                                                                                   // or localhosts);
            null, null );
  ...
  public void testMerge1() throws Exception {
    ...
    // and specifying to columns
    GPLoadMeta gpLoadMeta =
        createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_MERGE, GPLoadTests.TARGET_TABLE,
            GPLoadTests.GPLOAD_ERROR_TABLE, GPLoadTests.MERGE_DATA_FILE, ",", TABLE_FIELD, matchColumn, updateColumn,
            null, null, // no local host port or localhosts);
            null, null );
  ...
  public void testCommandLine1() throws Exception {
    ...
    GPLoadMeta gpLoadMeta =
        createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_INSERT, GPLoadTests.TARGET_TABLE,
            GPLoadTests.GPLOAD_ERROR_TABLE, GPLoadTests.INSERT_DATA_FILE, ",", pathToGPLoadExecutable,
            pathToControlFile, pathToLogfile, new String[0], new boolean[0], new boolean[0], null, null, // no local
                                                                                                         // host port or
                                                                                                         // localhosts);
            null, null );
  ...
  public void testCommandLine2() throws Exception {
    ...
    GPLoadMeta gpLoadMeta =
        createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_INSERT, GPLoadTests.TARGET_TABLE,
            GPLoadTests.GPLOAD_ERROR_TABLE, GPLoadTests.INSERT_DATA_FILE, ",", pathToGPLoadExecutable, null, null,
  ...
  public void testCommandLine4() throws Exception {
    ...
    GPLoadMeta gpLoadMeta =
        createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_INSERT, GPLoadTests.TARGET_TABLE,
            GPLoadTests.GPLOAD_ERROR_TABLE, GPLoadTests.INSERT_DATA_FILE, ",", invalidPath, null, null, new String[0],
  ...
  public void testCommandLine5() throws Exception {
    ...
    GPLoadMeta gpLoadMeta =
        createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_INSERT, GPLoadTests.TARGET_TABLE,
            GPLoadTests.GPLOAD_ERROR_TABLE, GPLoadTests.INSERT_DATA_FILE, ",", pathToGPLoadExecutable,
            pathToControlFile, invalidPath, new String[0], new boolean[0], new boolean[0], null, null, // no local host
                                                                                                       // port or
                                                                                                       // localhosts);
            null, null );
  ...
  public void testCommandLine6() throws Exception {
    ...
    GPLoadMeta gpLoadMeta =
        createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_INSERT, GPLoadTests.TARGET_TABLE,
            GPLoadTests.GPLOAD_ERROR_TABLE, GPLoadTests.INSERT_DATA_FILE, ",", pathToGPLoadExecutable,
            pathToControlFile, "/invalid path", new String[0], new boolean[0],
                new boolean[0], null, null, // no local host port or localhosts);
                null, null );
