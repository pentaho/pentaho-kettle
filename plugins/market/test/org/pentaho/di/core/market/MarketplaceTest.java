...
public class MarketplaceTest extends TestCase {
  ...
  private static final String description =
    "This is a plugin that is provided as an example on how to create a step plugin for PDI.";
  ...
  private static final String supportMessage =
    "Supported by a Pentaho Data Integration Enterprise Edition support contract.";
  ...
  public void testMarketEntryCreation() throws Exception {
    MarketEntry entry = new MarketEntry( ID, type, name, version, author, description,
      ...
      supportOrganization, supportUrl, minPdiVersion, maxPdiVersion );
