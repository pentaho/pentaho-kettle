...
public class GoogleDriveFileObject extends AbstractFileObject {
  ...
  public static final String SECURITY_TOKEN = "/client_secret.json";
  ...
  private Credential authorize() throws IOException {
    InputStream in = new FileInputStream( resolveCredentialsPath() + SECURITY_TOKEN );
  ...
  public static String resolveCredentialsPath() {
    ...
    path = path + PROJECT_NAME + CREDENTIALS_DIR;
    return path;
  }
}
