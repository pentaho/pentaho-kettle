...
@Step( id = "LDAPInput", name = "BaseStep.TypeLongDesc.LDAPInput",
        description = "BaseStep.TypeTooltipDesc.LDAPInput",
        categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.Input",
        image = "LIP.svg",
        documentationUrl = "http://wiki.pentaho.com/display/EAI/LDAP+Input",
        i18nPackageName = "org.pentaho.di.trans.steps.ldapinput" )
