...
public class PentahoAvroReadWriteTest {
  ...
  @Test
  public void testDefaultBooleanWithWrongValues() throws Exception {
    int expectedThrows = 5;
    int actualThrows = 0;
    String[] defaultValues = { "default#1", "default#2", "NotDouble", "NotDecimal", DEFAULT_INET_ADDR.getHostAddress(), "true", "-33456qw",
    ...
    for ( int i = 0; i < defaultValues.length; i++ ) { // Change 10 to the number of iterations you want
      try {
