...
public class S3CsvInputMeta extends BaseStepMeta implements StepMetaInterface, InputFileMetaInterface {
  ...
  public String getXML() {
    ...
    retval.append( "    " )
      .append( XMLHandler.addTagValue( "aws_access_key", Encr.encryptPasswordIfNotUsingVariables( awsAccessKey ) ) );
    retval.append( "    " )
      .append( XMLHandler.addTagValue( "aws_secret_key", Encr.encryptPasswordIfNotUsingVariables( awsSecretKey ) ) );
  ...
  public void check( List<CheckResultInterface> remarks, TransMeta transMeta, StepMeta stepinfo, RowMetaInterface prev,
    ...
    if ( prev == null || prev.size() == 0 ) {
      ...
      cr = new CheckResult( CheckResultInterface.TYPE_RESULT_ERROR,
        Messages.getString( "S3CsvInputMeta.eckResult.StepRecevingData", prev.size() + "" ),
  ...
  /**
   * @param lazyConversionActive true if lazy conversion is to be turned on: conversions are delayed as long as
   *                             possible, perhaps to never occur at all.
   */
