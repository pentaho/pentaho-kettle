...
public class RunConfigurationManagerTest {
  ...
  public void testOrdering() {
    ...
    defaultRunConfiguration5.setName( "y" );
    defaultRunConfiguration5.setPriority( 2 );
    executionConfigurationManager.save( defaultRunConfiguration5 );

    List<RunConfiguration> runConfigurations = executionConfigurationManager.load();

    assertEquals( runConfigurations.get( 0 ).getName(), "Pentaho local" );
    assertEquals( runConfigurations.get( 1 ).getName(), "d" );
    assertEquals( runConfigurations.get( 2 ).getName(), "f" );
    assertEquals( runConfigurations.get( 3 ).getName(), "x" );
    assertEquals( runConfigurations.get( 4 ).getName(), "y" );
