 ...
 */
@ExtensionPoint(
  id = "BeforeSaveToRepositoryExtensionPoint",
  extensionPointId = "BeforeSaveToRepository",
  description = "Save named connections in embedded meta store"
)
public class BeforeSaveToRepositoryExtensionPoint extends MetaStoreCopyExtensionPoint {

  public BeforeSaveToRepositoryExtensionPoint( MetastoreLocator metastoreLocator ) {
