...
/**
 * Abstract extension point for updating metastore reference when opening a file
 */
public class MetaLoadedExtensionPoint implements ExtensionPointInterface {

  /**
   * Update metastore reference
   *
  ...
  @Override public void callExtensionPoint( LogChannelInterface log, Object object ) throws KettleException {
    ConnectionUtil.init( (AbstractMeta) object );
  }
