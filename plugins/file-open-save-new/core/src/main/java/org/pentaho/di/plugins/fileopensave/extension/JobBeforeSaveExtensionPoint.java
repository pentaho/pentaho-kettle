 ...
 */
@ExtensionPoint(
  id = "JobBeforeSaveExtensionPoint",
  extensionPointId = "JobBeforeSave",
  description = "Save named connections in embedded meta store"
)
public final class JobBeforeSaveExtensionPoint extends MetaStoreCopyExtensionPoint {

  public JobBeforeSaveExtensionPoint( MetastoreLocator metastoreLocator ) {
