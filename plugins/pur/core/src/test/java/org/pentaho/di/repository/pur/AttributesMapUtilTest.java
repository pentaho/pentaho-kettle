...
public class AttributesMapUtilTest {
  ...
  public void testSaveAttributesMap_DefaultTag() throws Exception {
    ...
    PowerMockito.doCallRealMethod()
      .when( AttributesMapUtil.class, SAVE_ATTRIBUTES_MAP_METHOD, any( DataNode.class ),
        any( AttributesInterface.class ) );
    PowerMockito.doCallRealMethod()
      .when( AttributesMapUtil.class, SAVE_ATTRIBUTES_MAP_METHOD, any( DataNode.class ),
        any( AttributesInterface.class ),
        anyString() );
    ...
    assertEquals( A_VALUE,
      dataNode.getNode( AttributesMapUtil.NODE_ATTRIBUTE_GROUPS ).getNode( A_GROUP ).getProperty( A_KEY ).getString() );
  }
  ...
  public void testLoadAttributesMap_DefaultTag() throws Exception {
    ...
    PowerMockito.doCallRealMethod()
      .when( AttributesMapUtil.class, LOAD_ATTRIBUTES_MAP_METHOD, any( DataNode.class ),
        any( AttributesInterface.class ) );
    PowerMockito.doCallRealMethod()
      .when( AttributesMapUtil.class, LOAD_ATTRIBUTES_MAP_METHOD, any( DataNode.class ),
        any( AttributesInterface.class ),
