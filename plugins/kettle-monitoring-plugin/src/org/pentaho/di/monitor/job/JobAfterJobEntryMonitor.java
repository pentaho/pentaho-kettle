...
@ExtensionPoint(
  id = "JobAfterJobEntryExecutionMonitor",
  extensionPointId = "JobAfterJobEntryExecution",
  description = "After a job entry executes"
)
public class JobAfterJobEntryMonitor extends MonitorAbstract implements ExtensionPointInterface {
  ...
  public IKettleMonitoringEvent toKettleEvent( Object o ) throws KettleException {
    ...
    JobEntryEvent event = new JobEntryEvent( EventType.Job.AFTER_JOB_ENTRY ).build( ( JobExecutionExtension ) o );
