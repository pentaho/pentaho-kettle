 ...
 */
public class BeamRunConfigurationProvider extends MetaStoreRunConfigurationFactory
  implements RunConfigurationProvider {

  public static String TYPE = "Beam";
  private BeamRunConfigurationExecutor beamRunConfigurationExecutor;
  private List<String> supported = Arrays.asList( TransMeta.XML_TAG );

  public BeamRunConfigurationProvider( MetastoreLocator metastoreLocator,
                                       BeamRunConfigurationExecutor beamRunConfigurationExecutor ) {
    super( metastoreLocator );
    this.beamRunConfigurationExecutor = beamRunConfigurationExecutor;
  }

  @Override public RunConfiguration getConfiguration() {
    return new BeamRunConfiguration();
  }
  ...
  protected MetaStoreFactory<BeamRunConfiguration> getMetaStoreFactory() throws MetaStoreException {
    return getMetastoreFactory( BeamRunConfiguration.class );
  }

  @Override public RunConfigurationExecutor getExecutor() {
    return beamRunConfigurationExecutor;
  }
