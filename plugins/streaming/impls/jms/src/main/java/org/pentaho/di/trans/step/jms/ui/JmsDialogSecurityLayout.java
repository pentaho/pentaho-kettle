...
class JmsDialogSecurityLayout {
  ...
  JmsDialogSecurityLayout(
    ...
    SSL_TRUST_STORE_TYPE = "Trust Store Type";
    SSL_TRUST_STORE_PATH = "Trust Store Path";
    SSL_TRUST_STORE_PASSWORD = "Trust Store Password";
    SSL_KEY_STORE_TYPE = "Key Store Type";
    SSL_KEY_STORE_PATH = "Key Store Path";
    SSL_KEY_STORE_PASS = "Key Store Password";
    SSL_CONTEXT_ALGORITHM = "Context Algorithm";
    SSL_IBM_CIPHER_SUITE = "IBM Ciphersuite";
    SSL_IBM_FIPS_REQUIRED = "IBM FIPS Required";
  }
  ...
  protected void buildSecurityTab() {
    ...
    wAuthenticationGroup.setText( getString( PKG, "JmsDialog.Connection" ) );
