...
import static org.pentaho.di.core.row.ValueMetaInterface.typeCodes;
...
public class MQTTConsumerDialog extends BaseStreamingDialog implements StepDialogInterface {
  ...
  @Override protected void additionalOks( BaseStreamStepMeta meta ) {
    ...
    mqttMeta.messageDataType = Arrays.asList( typeCodes ).indexOf( fieldsTable.getTable().getItem( 0 ).getText( 3 ) );
