 ...
 * generated in the com.pentaho.di.services package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.pentaho.di.services
     * 
     */
    ...
    public JAXBElement<FileVersioningConfiguration> createFileVersioningConfiguration(FileVersioningConfiguration value) {
        return new JAXBElement<FileVersioningConfiguration>(_FileVersioningConfiguration_QNAME, FileVersioningConfiguration.class, null, value);
    }
