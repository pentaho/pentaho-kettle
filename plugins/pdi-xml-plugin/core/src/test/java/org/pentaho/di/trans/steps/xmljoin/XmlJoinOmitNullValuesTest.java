...
public class XmlJoinOmitNullValuesTest {
  ...
  public void testRemoveEmptyNodes() throws KettleException {
    doTest(
        ...
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?><root xmlns=\"http://www.myns1.com\" xmlns:xsi=\"http://www.myns2.com\" xsi:schemalocation=\"http://www.mysl1.com\"><child><subChild a=\"\"/><subChild><subSubChild a=\"\"/></subChild></child></root>" );
  }
