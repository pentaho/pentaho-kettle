...
public class KitchenTest extends TestCase {
  ...
  public void testArgumentMaxLogLines_invalid() {
    ...
    try {
      ...
      assertTrue(
          "Error is not as expected: " + expected.getMessage(), expected.getMessage().contains("ERROR: maxloglines"));  
    }
  }
  ...
  public void testArgumentMaxLogTimeout_invalid() {
    ...
    try {
      ...
      assertTrue(
          "Error is not as expected: " + expected.getMessage(), expected.getMessage().contains("ERROR: maxlogtimeout"));  
    }
  }
  ...
  public void testConfigureLogging() throws KettleException {
    ...
    CommandLineOption maxLogTimeoutOption = new CommandLineOption(
        "maxlogtimeout", null, new StringBuffer(maxLogTimeoutArg)); 
