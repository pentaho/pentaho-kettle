...
public class PluginRegistryTest extends TestCase {
  ...
  public void testPluginRegistry() throws KettlePluginException {
    ...
    if ( plugin == null ) {
      ...
      tableInputPlugin =
          new Plugin(
              new String[] { TABLE_INPUT_PLUGIN_ID, }, pluginTypeClass, StepMetaInterface.class, PLUGIN_INPUT_CATEGORY,
              TABLE_INPUT_PLUGIN_NAME, TABLE_INPUT_PLUGIN_DESCRIPTION, TABLE_INPUT_PLUGIN_IMAGE_FILE_NAME, false, true,
              classMap, new ArrayList<String>(), null, // No error help file
              null, // pluginFolder
