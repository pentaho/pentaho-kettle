...
public class LdapTlsProtocolTest {
  ...
  public void testLdapProtocolAddsLdapPrefixIfNecessary() throws KettleException, NamingException {
    ...
    TestableLdapTlsProtocol testableLdapProtocol = new TestableLdapTlsProtocol(mockLogChannelInterface,
        mockVariableSpace, mockLdapMeta, null);
  ...
  public void testLdapProtocolSetsSsl() throws KettleException {
    ...
    TestableLdapTlsProtocol testableLdapProtocol = new TestableLdapTlsProtocol(mockLogChannelInterface, mockVariableSpace,
        mockLdapMeta, null);
    testableLdapProtocol.connect(null, null);
