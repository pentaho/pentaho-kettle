...
public class DimensionLookupTest {
	...
	public void setup() {
		...
		dimensionLookup = new DimensionLookup(mockStepMeta,
				mockDimensionLookupData, 0, mockTransMeta,
				mockTrans);
	...
	@Test
	public void testDimInsertPreparesStatementWithoutReturnKeysForNotNullTechnicalKey() throws KettleException, SQLException {
		RowMetaInterface mockMetaInterface = mock(RowMetaInterface.class);
		Object [] row = new Object[0];
		Long technicalKey = 0L;
		boolean newEntry = false;
		Long versionNr = 2L;
		Date dateFrom = new Date();
		Date dateTo = new Date();
