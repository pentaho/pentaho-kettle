...
public class XsltTest extends TestCase {
	...
	public RowMetaInterface createRowMetaInterface() {
		...
		ValueMetaInterface[] valuesMeta = { 
			new ValueMeta("XML", ValueMeta.TYPE_STRING), 
			new ValueMeta("XSL", ValueMeta.TYPE_STRING),
	...
	public RowMetaInterface createResultRowMetaInterface() {
		...
		ValueMetaInterface[] valuesMeta = { 
			...
			new ValueMeta("XSL",	  ValueMeta.TYPE_STRING),
			new ValueMeta("filename", ValueMeta.TYPE_STRING),
			new ValueMeta("result",	  ValueMeta.TYPE_STRING),
		};		
	...
	public void runTestWithParams(String xmlFieldname,
								  ...
								  String xslFileField,
								  String xslFilename,
								  String xslFactory) throws Exception {
		...
		StepMeta xsltStep = new StepMeta(xsltPid, xsltName,
				xm);
