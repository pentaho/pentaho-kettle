...
public class TransformationHasTransLogConfiguredImportRuleTest extends TestCase {
  ...
  public void testRule() throws Exception {
    ...
    assertNotNull(
        "The 'transformation has trans log table configured' rule could not be found in the plugin registry!", plugin );
    ...
    assertNotNull(
        "The 'transformation has trans log table configured' class could not be loaded by the plugin registry!", plugin );
    ...
    feedback = rule.verifyRule( transMeta );
    assertTrue(
        "We didn't expect any feedback from the 'transformation has trans log table configured' since the rule is not enabled",
        feedback.isEmpty() );
  }
}
