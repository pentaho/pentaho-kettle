...
set CLASSPATH=%CLASSPATH%;libext\db2jcc_license_c.jar
...
set CLASSPATH=%CLASSPATH%;libext\jtds-1.1.jar
...
set OPT=-Xmx256m -cp %CLASSPATH% -Djava.library.path=libswt\win32\ -DKETTLE_HOME=%KETTLE_HOME%  -DPTV_HOME=%PTV_HOME%
