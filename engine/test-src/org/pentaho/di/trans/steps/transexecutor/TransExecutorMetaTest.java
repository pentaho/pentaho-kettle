...
public class TransExecutorMetaTest {
  ...
  @Test
  public void testConstructorAllocateArrays() {
    TransExecutorMeta meta = new TransExecutorMeta();
    assertNotNull( meta.getOutputRowsField() );
    assertNotNull( meta.getOutputRowsType() );
    assertNotNull( meta.getOutputRowsLength() );
    assertNotNull( meta.getOutputRowsPrecision() );
  }
