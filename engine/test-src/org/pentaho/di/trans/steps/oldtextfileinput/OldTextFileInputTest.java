...
public class OldTextFileInputTest {
  ...
  public void testGetLineDOS() throws KettleFileException, UnsupportedEncodingException {
    ...
    String output = OldTextFileInput.getLine( null, getInputStreamReader( input ),
        OldTextFileInputMeta.FILE_FORMAT_DOS, new StringBuilder( 1000 ) );
  ...
  public void testGetLineUnix() throws KettleFileException, UnsupportedEncodingException {
    ...
    String expected = "col1\tcol2\tcol3";
    String output = OldTextFileInput.getLine( null, getInputStreamReader( input ),
        OldTextFileInputMeta.FILE_FORMAT_UNIX, new StringBuilder( 1000 ) );
    assertEquals( expected, output );
  }
  ...
  public void testGetLineMixed() throws KettleFileException, UnsupportedEncodingException {
    ...
    String expected = "col1\tcol2\tcol3";
    String output = OldTextFileInput.getLine( null, getInputStreamReader( input ),
        OldTextFileInputMeta.FILE_FORMAT_MIXED, new StringBuilder( 1000 ) );
    assertEquals( expected, output );
  }
  ...
  public void test_PDI695() throws KettleFileException, UnsupportedEncodingException {
    ...
    assertEquals( expected, OldTextFileInput.getLine( null, getInputStreamReader( inputDOS ),
        OldTextFileInputMeta.FILE_FORMAT_UNIX, new StringBuilder( 1000 ) ) );
    assertEquals( expected, OldTextFileInput.getLine( null, getInputStreamReader( inputUnix ),
        OldTextFileInputMeta.FILE_FORMAT_UNIX, new StringBuilder( 1000 ) ) );
    assertEquals( expected, OldTextFileInput.getLine( null, getInputStreamReader( inputOSX ),
        OldTextFileInputMeta.FILE_FORMAT_UNIX, new StringBuilder( 1000 ) ) );
  }
