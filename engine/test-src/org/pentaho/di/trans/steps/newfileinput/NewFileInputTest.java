...
public class NewFileInputTest {
  ...
  public void testGetLineDOS() throws KettleFileException, UnsupportedEncodingException {
    ...
    String output =
        NewFileInputUtils.getLine( null, getInputStreamReader( input ), NewFileInputMeta.FILE_FORMAT_DOS,
  ...
  public void testGetLineUnix() throws KettleFileException, UnsupportedEncodingException {
    ...
    String expected = "col1\tcol2\tcol3";
    String output =
        NewFileInputUtils.getLine( null, getInputStreamReader( input ), NewFileInputMeta.FILE_FORMAT_UNIX,
            new StringBuilder( 1000 ) );
    assertEquals( expected, output );
  }
  ...
  public void testGetLineMixed() throws KettleFileException, UnsupportedEncodingException {
    ...
    String expected = "col1\tcol2\tcol3";
    String output =
        NewFileInputUtils.getLine( null, getInputStreamReader( input ), NewFileInputMeta.FILE_FORMAT_MIXED,
            new StringBuilder( 1000 ) );
    assertEquals( expected, output );
  }
  ...
  public void test_PDI695() throws KettleFileException, UnsupportedEncodingException {
    ...
    assertEquals( expected, NewFileInputUtils.getLine( null, getInputStreamReader( inputDOS ),
        NewFileInputMeta.FILE_FORMAT_UNIX, new StringBuilder( 1000 ) ) );
    assertEquals( expected, NewFileInputUtils.getLine( null, getInputStreamReader( inputUnix ),
        NewFileInputMeta.FILE_FORMAT_UNIX, new StringBuilder( 1000 ) ) );
    assertEquals( expected, NewFileInputUtils.getLine( null, getInputStreamReader( inputOSX ),
        NewFileInputMeta.FILE_FORMAT_UNIX, new StringBuilder( 1000 ) ) );
  }
  ...
  public void readWrappedInputWithoutHeaders() throws Exception {
    ...
    meta.inputFiles.inputFields =
        new NewFileInputField[] { new NewFileInputField( "col1", -1, -1 ), new NewFileInputField( "col2", -1, -1 ) };
    ...
    NewFileInputData data = new NewFileInputData();
    ...
    data.fileFormatType = NewFileInputMeta.FILE_FORMAT_UNIX;
    data.separator = ";";
    data.filterProcessor = new NewFileFilterProcessor( new NewFileFilter[0] );
    data.filePlayList = new FilePlayListAll();

    RowSet output = new BlockingRowSet( 5 );
    NewFileInput input = StepMockUtil.getStep( NewFileInput.class, NewFileInputMeta.class, "test" );
