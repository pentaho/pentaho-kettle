...
public class PDI_2875_Test {
  private static StepMockHelper<NewFileInputMeta, NewFileInputData> smh;
  ...
  public static void setUp() throws KettleException {
    ...
    smh =
      new StepMockHelper<NewFileInputMeta, NewFileInputData>( "CsvInputTest", NewFileInputMeta.class, NewFileInputData.class );
  ...
  private NewFileInputMeta getMeta() {
    ...
    meta.setFilter( new NewFileFilter[0] );
  ...
  public void testVariableSubstitution() {
    ...
    NewFileInput step = spy( new NewFileInput( smh.stepMeta, smh.stepDataInterface, 0, smh.transMeta, smh.trans ) );
