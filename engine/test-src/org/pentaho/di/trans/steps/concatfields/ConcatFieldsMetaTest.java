...
import org.pentaho.di.trans.steps.textfileoutput.TextFileFieldLoadSaveValidator;
...
public class ConcatFieldsMetaTest {
  ...
  public void setUpLoadSave() throws Exception {
    ...
    // Before you judge, the ConcatFieldsMeta class subclasses TextFileOutputMeta. So this
    // class ends up testing TextFileOutputMeta as well as ConcatFieldsMeta... I'm not particularly
    // happy about it, but unfortunately, the persister methods in ConcatFieldsMeta call the persister in the
    // super class (TextFileOutputMeta), and without working it this way, you get an NPE.
    // An alternate solution might be to add special methods to ConcatFieldsMeta to *not* call the superclass,
    // but that seemed like worse kludge to me.
    //
    // MB - 5/2016

    List<String> attributes =
        Arrays.asList( "targetFieldName", "targetFieldLength", "removeSelectedFields",
            "separator", "enclosure", "enclosure_forced", "enclosure_fix_disabled", "header", "footer",
    ...
    getterMap.put( "targetFieldName", "getTargetFieldName" );
    ...
    loadSaveTester =
        new LoadSaveTester( ConcatFieldsMeta.class, attributes, getterMap, setterMap,
