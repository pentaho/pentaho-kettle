 ...
 * <br/>
 * <a href=
 * "#loadRep(org.pentaho.di.repository.Repository, org.pentaho.di.repository.ObjectId, java.util.List, java.util.List)">
 ...
 * entry id given in the arguments should be used as the identifier when using the repository's serialization methods.<br/>
 * <br/>
