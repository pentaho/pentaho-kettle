...
public class ResourceUtil {
  ...
  public static final TopLevelResource serializeResourceExportInterface( String zipFilename,
    ...
    return serializeResourceExportInterface(
        zipFilename, resourceExportInterface, space, repository, metaStore, injectXML, injectFilename, true );
  }
  ...
  public static final TopLevelResource serializeResourceExportInterface( String zipFilename,
    ResourceExportInterface resourceExportInterface, VariableSpace space, Repository repository,
    IMetaStore metaStore, String injectXML, String injectFilename, boolean passingExport ) throws KettleException {
  ...
  private static void zipFile(ZipOutputStream out,String originalPath,String filename,String fullname,String context) throws IOException
  {
    ZipEntry zipEntry = new ZipEntry( filename );

    String comment =
      BaseMessages.getString(
        PKG, "ResourceUtil.SerializeResourceExportInterface.ZipEntryComment.OriginatingFile", fullname,
        Const.NVL( originalPath, "-" ) );
