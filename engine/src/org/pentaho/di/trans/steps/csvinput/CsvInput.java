  ...
  public boolean init(StepMetaInterface smi, StepDataInterface sdi)
	{
		...
		if (super.init(smi, sdi)) {
			...
			String realEncoding = (Const.isEmpty(meta.getEncoding())) ? 
					meta.getEncoding() : 
					meta.getEncoding().trim().startsWith(StringUtil.UNIX_OPEN) ? getVariable(meta.getEncoding(),meta.getEncoding()): environmentSubstitute(meta.getEncoding());
