 ...
 */
public abstract class BaseInputStepMeta extends BaseStepMeta {
    ...
    public final String[] RequiredFilesDesc = new String[] { BaseMessages.getString(PKG, "System.Combo.No"),
    ...
    public static class InputFiles implements Cloneable {
        ...
        public NewFileInputField[] inputFields;
    ...
    public static class AdditionalOutputFields implements Cloneable {
        ...
        /**
         * Set null for all empty field values to be able to fast check during step processing. Need to be
    ...
    public Object clone() {
        BaseInputStepMeta retval = (BaseInputStepMeta) super.clone();
    ...
    public FileInputList getNewFileList(VariableSpace space) {
        return FileInputList.createFileList(space, inputFiles.fileName, inputFiles.fileMask,
