...
public class ExcelInputMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public void setDefault() {
    ...
    fileMask[ 0 ] = StringUtil.EMPTY_STRING;
    excludeFileMask[ 0 ] = StringUtil.EMPTY_STRING;
    fileRequired[ 0 ] = NO;
    includeSubFolders[ 0 ] = NO;

    field[ 0 ] = new ExcelInputField();
    field[ 0 ].setName( "field 1" );
    field[ 0 ].setType( ValueMetaInterface.TYPE_NUMBER );
    field[ 0 ].setLength( 9 );
    field[ 0 ].setPrecision( 2 );
    field[ 0 ].setTrimType( TYPE_TRIM_NONE );
    field[ 0 ].setRepeated( false );
