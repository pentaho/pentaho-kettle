...
public class ParGzipCsvInputMetaInjection implements StepMetaInjectionInterface {
  ...
  private enum Entry {
    ...
    FILENAME(ValueMetaInterface.TYPE_STRING, "The file name to read"),
    FILENAME_FIELD(ValueMetaInterface.TYPE_STRING, "The filename field (if the step reads file names)"),
    INCLUDING_FILENAMES(ValueMetaInterface.TYPE_STRING, "Include file name in output? (Y/N)"),
    ROW_NUMBER_FIELD(ValueMetaInterface.TYPE_STRING, "The row number field"),
    HEADER_PRESENT(ValueMetaInterface.TYPE_STRING, "Is there a header row? (Y/N)"),
    DELIMITER(ValueMetaInterface.TYPE_STRING, "The field delimiter"),
    ENCLOSURE(ValueMetaInterface.TYPE_STRING, "The field enclosure"),
    BUFFER_SIZE(ValueMetaInterface.TYPE_STRING, "I/O buffer size"),
    LAZY_CONVERSION(ValueMetaInterface.TYPE_STRING, "Use lazy conversion? (Y/N)"),
    ADD_FILES_TO_RESULT(ValueMetaInterface.TYPE_STRING, "Add files to result? (Y/N)"),
    RUN_IN_PARALLEL(ValueMetaInterface.TYPE_STRING, "Run in parallel? (Y/N)"),
  ...
  public List<StepInjectionMetaEntry> getStepInjectionMetadataEntries() throws KettleException {
    ...
    Entry[] topEntries = new Entry[] { Entry.FILENAME, Entry.FILENAME_FIELD, Entry.INCLUDING_FILENAMES, 
        Entry.ROW_NUMBER_FIELD, Entry.HEADER_PRESENT, Entry.DELIMITER, Entry.ENCLOSURE, Entry.BUFFER_SIZE, 
        Entry.LAZY_CONVERSION, Entry.ADD_FILES_TO_RESULT, Entry.RUN_IN_PARALLEL, Entry.ENCODING, };
