...
public class NewFileInputField implements Cloneable, NewFileInputFieldInterface {
  private String name;
  ...
  public NewFileInputField( String fieldname, int position, int length ) {
    this.name = fieldname;
  ...
  public int compareTo( NewFileInputFieldInterface field ) {
    return position - field.getPosition();
  }
  ...
  public NewFileInputFieldInterface createNewInstance( String newFieldname, int x, int newlength ) {
    return new NewFileInputField( newFieldname, x, newlength );
  }
}
