...
public class NewFileFilter implements Cloneable {
   ...
   *
   */
  public NewFileFilter( int filterPosition, String filterString, boolean filterLastLine, boolean filterPositive ) {
