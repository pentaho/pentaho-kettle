...
import org.pentaho.di.trans.steps.baseinput.BaseInputStepMeta.InputFiles;
import org.pentaho.metastore.api.IMetaStore;
import org.w3c.dom.Node;

import com.google.common.annotations.VisibleForTesting;

public class NewFileInputMeta extends BaseInputStepMeta implements StepMetaInterface {
  private static Class<?> PKG = NewFileInputMeta.class; // for i18n purposes, needed by Translator2!! TODO: check i18n for base
   ...
   */
  public NewFileFilter[] getFilter() {
    return filter;
  }
   ...
   */
  public void setFilter( NewFileFilter[] filter ) {
    this.filter = filter;
  }
  ...
  public void loadXML( Node stepnode, List<DatabaseMeta> databases, IMetaStore metaStore ) throws KettleXMLException {
    try {
      ...
      if ( XMLHandler.getTagValue( stepnode, "filter" ) != null ) {
        filter = new NewFileFilter[1];
        filter[0] = new NewFileFilter();
  ...
  public Object clone() {
    NewFileInputMeta retval = (NewFileInputMeta) super.clone();
    ...
    for ( int i = 0; i < nrfields; i++ ) {
      retval.inputFiles.inputFields[i] = (NewFileInputField) inputFiles.inputFields[i].clone();
    }

    for ( int i = 0; i < nrfilters; i++ ) {
      retval.filter[i] = (NewFileFilter) filter[i].clone();
    }
  ...
  public void allocate( int nrfiles, int nrfields, int nrfilters ) {
    ...
    inputFiles.inputFields = new NewFileInputField[nrfields];
    filter = new NewFileFilter[nrfilters];
  }
  ...
  public void setDefault() {
    ...
    for ( int i = 0; i < nrfields; i++ ) {
      inputFiles.inputFields[i] = new NewFileInputField( "field" + ( i + 1 ), 1, -1 );
    }
  ...
  public void getFields( RowMetaInterface row, String name, RowMetaInterface[] info, StepMeta nextStep,
    ...
    for ( int i = 0; i < inputFiles.inputFields.length; i++ ) {
      NewFileInputField field = inputFiles.inputFields[i];
  ...
  public void check( List<CheckResultInterface> remarks, TransMeta transMeta, StepMeta stepMeta,
    ...
    FileInputList textFileList = getNewFileList( transMeta );
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new NewFileInput( stepMeta, stepDataInterface, cnr, transMeta, trans );
  }

  public StepDataInterface getStepData() {
    return new NewFileInputData();
  }
  ...
  public int getFileFormatTypeNr() {
    ...
    if ( content.fileFormat.equalsIgnoreCase( "DOS" ) ) {
      ...
      return NewFileInputMeta.FILE_FORMAT_UNIX;
    } else {
      return NewFileInputMeta.FILE_FORMAT_MIXED;
    }
  }
  ...
  public int getFileTypeNr() {
    ...
    if ( content.fileType.equalsIgnoreCase( "CSV" ) ) {
      return NewFileInputMeta.FILE_TYPE_CSV;
    } else {
      return NewFileInputMeta.FILE_TYPE_FIXED;
    }
  }
  ...
  public StepMetaInjectionInterface getStepMetaInjectionInterface() {
    return new NewFileInputMetaInjection( this );
  }
