...
public class DimensionLookupMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public String getXML() {
    ...
    retval
        .append( "      " ).append( XMLHandler.addTagValue( "use_start_date_alternative", usingStartDateAlternative ) );
    retval.append( "      " ).append(
  ...
  public void saveRep( Repository rep, IMetaStore metaStore, ObjectId id_transformation, ObjectId id_step )
    ...
    try {
      ...
      rep.saveStepAttribute(
          id_transformation, id_step, "start_date_alternative", getStartDateAlternativeCode( startDateAlternative ) );
                  ...
                  if ( dimvalue == null ) {
                    ...
                    error_message +=
                        "\t\t"
                            + dimfield
                            + BaseMessages.getString(
                                PKG, "DimensionLookupMeta.CheckResult.KeyNotPresentInDimensiontable" ) + schemaTable
                            + ")" + Const.CR;
                  } else {
      ...
      if ( !update ) {
        ...
        for ( int i = 0; i < fieldLookup.length; i++ ) {
          ...
          DatabaseImpact ii =
              new DatabaseImpact(
                  DatabaseImpact.TYPE_IMPACT_READ_WRITE, transMeta.getName(), stepMeta.getName(), databaseMeta
                      .getDatabaseName(), tableName, fieldLookup[i], fieldLookup[i], v == null ? "" : v.getOrigin(),
                  "", v == null ? "" : "Type = " + v.toStringMeta() );
          impact.add( ii );
        }
      }
