...
public class TextFileInputMetaInjection implements StepMetaInjectionInterface {
  ...
  private enum Entry {
    ...
    FILE_TYPE( ValueMetaInterface.TYPE_STRING, "File type (CSV/Fixed)" ), SEPARATOR(
        ...
        ValueMetaInterface.TYPE_STRING, "File format (DOS, UNIX, mixed)" ), ROW_LIMIT(
        ...
        ValueMetaInterface.TYPE_STRING, "The target directory for the line number files" ), LINE_NR_FILES_EXTENTION(
        ValueMetaInterface.TYPE_STRING, "The line number files' extension" ), ERROR_LINES_SKIPPED(
        ValueMetaInterface.TYPE_STRING, "Skip error lines? (Y/N)" ),
    ...
    FIELD_DECIMAL( ValueMetaInterface.TYPE_STRING, "Decimal symbol" ), FIELD_GROUP(
        ...
        ValueMetaInterface.TYPE_STRING, "The null string" ),
    ...
    FILTERS( ValueMetaInterface.TYPE_NONE, "The filter definitions" ), FILTER(
        ...
        ValueMetaInterface.TYPE_STRING, "Position" ), FILTER_STRING( ValueMetaInterface.TYPE_STRING, "Filter string" ),
    FILTER_LAST_LINE( ValueMetaInterface.TYPE_STRING, "Stop reading when filter found? (Y/N)" ), FILTER_POSITIVE(
  ...
  public List<StepInjectionMetaEntry> getStepInjectionMetadataEntries() throws KettleException {
    ...
    Entry[] topEntries =
        new Entry[] {
            Entry.FILE_TYPE, Entry.SEPARATOR, Entry.ENCLOSURE, Entry.ESCAPE_CHAR, Entry.BREAK_IN_ENCLOSURE,
