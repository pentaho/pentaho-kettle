...
public class OldTextFileFilter implements Cloneable {
   ...
   *
   */
  public OldTextFileFilter( int filterPosition, String filterString, boolean filterLastLine, boolean filterPositive ) {
