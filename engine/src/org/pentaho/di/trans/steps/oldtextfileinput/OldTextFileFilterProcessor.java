 ...
 * @author Sven Boden
 */
public class OldTextFileFilterProcessor {

  /** The filters to process */
  private OldTextFileFilter[] filters;
   ...
   *          The filters to process
   */
  public OldTextFileFilterProcessor( OldTextFileFilter[] filters ) {
  ...
  public boolean doFilters( String line ) {
    ...
    for ( int f = 0; f < filters.length && filterOK; f++ ) {
      OldTextFileFilter filter = filters[f];
