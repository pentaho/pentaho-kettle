 ...
 * @author Matt
 */
public class OldTextFileInputMetaInjection implements StepMetaInjectionInterface {
  ...
  private final OldTextFileInputMeta meta;

  public OldTextFileInputMetaInjection( OldTextFileInputMeta meta ) {
    this.meta = meta;
  }
  ...
  public void injectStepMetadataEntries( List<StepInjectionMetaEntry> all ) throws KettleException {
    ...
    List<OldTextFileFilter> filters = new ArrayList<OldTextFileFilter>();
        ...
        case FILTERS:
          for ( StepInjectionMetaEntry lookField : lookFields.getDetails() ) {
            ...
            if ( fieldEntry == Entry.FILTER ) {
              OldTextFileFilter filterLine = new OldTextFileFilter();
    ...
    if ( filters.size() > 0 ) {
      meta.setFilter( filters.toArray( new OldTextFileFilter[filters.size()] ) );
    }
  ...
  public OldTextFileInputMeta getMeta() {
    return meta;
  }
}
