...
public class OldTextFileInputMeta extends BaseStepMeta implements StepMetaInterface, InputFileMetaInterface {
  ...
  /** The filters to use... */
  private OldTextFileFilter[] filter;
   ...
   */
  public OldTextFileFilter[] getFilter() {
    return filter;
  }
   ...
   */
  public void setFilter( OldTextFileFilter[] filter ) {
    this.filter = filter;
  }
  ...
  public void loadXML( Node stepnode, List<DatabaseMeta> databases, IMetaStore metaStore ) throws KettleXMLException {
    try {
      ...
      if ( XMLHandler.getTagValue( stepnode, "filter" ) != null ) {
        filter = new OldTextFileFilter[1];
        filter[0] = new OldTextFileFilter();
        ...
        for ( int i = 0; i < nrfilters; i++ ) {
          ...
          filter[i] = new OldTextFileFilter();
  ...
  public Object clone() {
    OldTextFileInputMeta retval = (OldTextFileInputMeta) super.clone();
    ...
    for ( int i = 0; i < nrfilters; i++ ) {
      retval.filter[i] = (OldTextFileFilter) filter[i].clone();
    }
  ...
  public void allocate( int nrfiles, int nrfields, int nrfilters ) {
    ...
    filter = new OldTextFileFilter[nrfilters];
  }
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new OldTextFileInput( stepMeta, stepDataInterface, cnr, transMeta, trans );
  }

  public StepDataInterface getStepData() {
    return new OldTextFileInputData();
  }
  ...
  public int getFileFormatTypeNr() {
    ...
    if ( getFileFormat().equalsIgnoreCase( "DOS" ) ) {
      ...
      return OldTextFileInputMeta.FILE_FORMAT_UNIX;
    } else {
      return OldTextFileInputMeta.FILE_FORMAT_MIXED;
    }
  }
  ...
  public int getFileTypeNr() {
    ...
    if ( getFileType().equalsIgnoreCase( "CSV" ) ) {
      return OldTextFileInputMeta.FILE_TYPE_CSV;
    } else {
      return OldTextFileInputMeta.FILE_TYPE_FIXED;
    }
  }
  ...
  public StepMetaInjectionInterface getStepMetaInjectionInterface() {
    return new OldTextFileInputMetaInjection( this );
  }
