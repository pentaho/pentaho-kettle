...
/**
 * This takes care of the external metadata injection into the UpdateMeta class
 *
 * @author Chris
 */
public class UpdateMetaInjection implements StepMetaInjectionInterface {
  ...
  public enum Entry implements StepMetaInjectionEntryInterface {
    ...
    BATCH_UPDATE( ValueMetaInterface.TYPE_STRING, "Use batch updates? (Y/N)" ),
    SKIP_LOOKUP( ValueMetaInterface.TYPE_STRING, "Skip lookup? (Y/N)" ),
    IGNORE_LOOKUP_FAILURE( ValueMetaInterface.TYPE_STRING, "Ignore lookup failure? (Y/N)" ),
    FLAG_FIELD( ValueMetaInterface.TYPE_STRING, "Flag field (key found)" ),
  ...
  public UpdateMetaInjection( UpdateMeta meta ) {
    this.meta = meta;
  }
  ...
  public List<StepInjectionMetaEntry> getStepInjectionMetadataEntries() throws KettleException {
    ...
    Entry[] topEntries =
      new Entry[] {
        Entry.TARGET_SCHEMA, Entry.TARGET_TABLE, Entry.COMMIT_SIZE, Entry.BATCH_UPDATE, Entry.SKIP_LOOKUP,
        Entry.IGNORE_LOOKUP_FAILURE, Entry.FLAG_FIELD, };
  ...
  public List<StepInjectionMetaEntry> extractStepMetadataEntries() throws KettleException {
    ...
    list.add( StepInjectionUtil.getEntry( Entry.BATCH_UPDATE, meta.useBatchUpdate() ) );
    list.add( StepInjectionUtil.getEntry( Entry.SKIP_LOOKUP, meta.isSkipLookup() ) );
    list.add( StepInjectionUtil.getEntry( Entry.IGNORE_LOOKUP_FAILURE, meta.isErrorIgnored() ) );
    list.add( StepInjectionUtil.getEntry( Entry.FLAG_FIELD, meta.getIgnoreFlagField() ) );
