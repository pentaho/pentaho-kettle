  ...
  public boolean processRow( StepMetaInterface smi, StepDataInterface sdi ) throws KettleException {
    ...
    if ( first ) {
      ...
      for ( int i = 0; i < meta.getKeyStream().length; i++ ) {
        ...
        if ( data.keynrs[i] < 0 && // couldn't find field!
          ...
          throw new KettleStepException( BaseMessages.getString( PKG,
              "SynchronizeAfterMerge.Exception.FieldRequired", meta.getKeyStream()[i] ) );
        }
        ...
        if ( data.keynrs2[i] < 0 && // couldn't find field!
          ...
          throw new KettleStepException( BaseMessages.getString( PKG,
              "SynchronizeAfterMerge.Exception.FieldRequired", meta.getKeyStream2()[i] ) );
        }
      ...
      for ( int i = 0; i < meta.getUpdateLookup().length; i++ ) {
        ...
        {
          throw new KettleStepException( BaseMessages.getString( PKG,
              "SynchronizeAfterMerge.Exception.FieldRequired", meta.getUpdateStream()[i] ) );
        }
        if ( log.isDebug() )
          logDebug( BaseMessages.getString( PKG, "SynchronizeAfterMerge.Log.FieldHasDataNumbers", meta
              .getUpdateStream()[i] )
