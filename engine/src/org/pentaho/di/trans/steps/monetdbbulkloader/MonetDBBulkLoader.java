...
public class MonetDBBulkLoader extends BaseStep implements StepInterface
{
  ...
  protected void writeRowToMonetDB(RowMetaInterface rowMeta, Object[] r) throws KettleException {
    ...
    if(truncateStatement == null) throw new KettleException("Truncate table is not supported!");
  ...
  /*
   * executeSQL
   *   Uses the MonetDB API to create a new server connection and
   *   the associated buffered Reader and Writer to execute a single query.
   *   @param Query string
   *   @param Host URI
