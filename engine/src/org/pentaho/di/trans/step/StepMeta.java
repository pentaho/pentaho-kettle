...
public class StepMeta extends SharedObjectBase implements Cloneable, Comparable<StepMeta>, GUIPositionInterface,
  ...
  public String getXML( boolean includeInterface ) throws KettleException {
    ...
    retval.append( "      " ).append( XMLHandler.openTag( "xloc" ) ).append( location.x ).append( XMLHandler.closeTag( "xloc" ) ).append( Const.CR );
    retval.append( "      " ).append( XMLHandler.openTag( "yloc" ) ).append( location.y ).append( XMLHandler.closeTag( "yloc" ) ).append( Const.CR );
    retval.append( "      " ).append( XMLHandler.openTag( "draw" ) ).append( ( drawstep ? "Y" : "N" ) ).append( XMLHandler.closeTag( "draw" ) ).append( Const.CR );
