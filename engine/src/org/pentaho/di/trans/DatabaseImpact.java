...
public class DatabaseImpact {
  ...
  public RowMetaAndData getRow() {
    ...
    r.addValue(
        new ValueMeta(
            BaseMessages.getString( PKG, "DatabaseImpact.RowDesc.Label.Database" ), ValueMetaInterface.TYPE_STRING ),
        getDatabaseName() );
    r.addValue(
        new ValueMeta(
    ...
    r.addValue( new ValueMeta(
        BaseMessages.getString( PKG, "DatabaseImpact.RowDesc.Label.SQL" ), ValueMetaInterface.TYPE_STRING ), getSQL() );
    r.addValue(
        new ValueMeta(
            BaseMessages.getString( PKG, "DatabaseImpact.RowDesc.Label.Remarks" ), ValueMetaInterface.TYPE_STRING ),
        getRemark() );
