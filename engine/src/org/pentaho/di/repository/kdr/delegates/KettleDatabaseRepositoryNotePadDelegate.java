...
public class KettleDatabaseRepositoryNotePadDelegate extends KettleDatabaseRepositoryBaseDelegate {
  ...
  public synchronized ObjectId insertNote( String note, long gui_location_x, long gui_location_y,
    ...
    table.addValue(
      new ValueMeta( KettleDatabaseRepository.FIELD_NOTE_ID_NOTE, ValueMetaInterface.TYPE_INTEGER ), id );
    table.addValue(
    ...
    table.addValue( new ValueMeta(
      KettleDatabaseRepository.FIELD_NOTE_GUI_LOCATION_X, ValueMetaInterface.TYPE_INTEGER ), new Long(
      gui_location_x ) );
    table.addValue( new ValueMeta(
      KettleDatabaseRepository.FIELD_NOTE_GUI_LOCATION_Y, ValueMetaInterface.TYPE_INTEGER ), new Long(
      gui_location_y ) );
    table.addValue( new ValueMeta(
    ...
    table.addValue(
      new ValueMeta( KettleDatabaseRepository.FIELD_NOTE_FONT_BOLD, ValueMetaInterface.TYPE_BOOLEAN ), Boolean
        .valueOf( fontbold ) );
    table.addValue( new ValueMeta(
      KettleDatabaseRepository.FIELD_NOTE_FONT_ITALIC, ValueMetaInterface.TYPE_BOOLEAN ), Boolean
      .valueOf( fontitalic ) );
    // Font color
    table.addValue(
      new ValueMeta( KettleDatabaseRepository.FIELD_NOTE_COLOR_RED, ValueMetaInterface.TYPE_INTEGER ), new Long(
        fontcolorred ) );
    table.addValue( new ValueMeta(
      KettleDatabaseRepository.FIELD_NOTE_COLOR_GREEN, ValueMetaInterface.TYPE_INTEGER ), new Long(
      fontcolorgreen ) );
    table.addValue(
      new ValueMeta( KettleDatabaseRepository.FIELD_NOTE_COLOR_BLUE, ValueMetaInterface.TYPE_INTEGER ),
    ...
    table.addValue( new ValueMeta(
      ...
      fontbordercolorblue ) );
    table.addValue( new ValueMeta(
      KettleDatabaseRepository.FIELD_NOTE_DRAW_SHADOW, ValueMetaInterface.TYPE_BOOLEAN ), Boolean
      .valueOf( drawshadow ) );
