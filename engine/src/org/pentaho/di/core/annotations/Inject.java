...
public @interface Inject {
   ...
   * <ol>
   * <li>
   * <u>Fields:</u> The name of the annotated field. For instance, annotating a field named "callerId" with @Inject has
   * the same effect as annotating this field with @Inject("callerId")</li>
