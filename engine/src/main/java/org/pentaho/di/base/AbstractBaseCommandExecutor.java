...
import com.pentaho.oauth.client.BrokerAuthClient;
import com.pentaho.oauth.client.BrokerAuthClient.BrokerFlowResult;
import com.pentaho.oauth.client.BrokerDiscoveryClient;
import com.pentaho.oauth.client.BrowserAuthSessionHolder;
import com.pentaho.oauth.client.DPoPProofBuilder;
...
import org.pentaho.di.pan.auth.SharedBrowserAuthSessionHolder;
...
public abstract class AbstractBaseCommandExecutor {
  ...
  private AuthResult resolveAuthentication( String serverUrl,
    ...
    BrowserAuthSessionHolder holder = getBrowserAuthSessionHolder();
  ...
  protected BrowserAuthSessionHolder getBrowserAuthSessionHolder() {
    return SharedBrowserAuthSessionHolder.get();
  }
  ...
  private AuthResult tryBrokerClientCredentials( BrowserAuthSessionHolder holder,
    ...
    // Phase 1 migration: service-account now uses direct access-token auth,
    // matching device-code and PKCE instead of collapsing into JSESSIONID.
