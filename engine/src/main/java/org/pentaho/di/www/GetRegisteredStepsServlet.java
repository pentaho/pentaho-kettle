...
/**
 *
 *This class contains api's to fetch registered steps.
 *
 * @since 2024
 * @author sVarma1992
 *
  ...
  public void doGet( HttpServletRequest request, HttpServletResponse response ) throws ServletException,
    ...
    if ( request.getParameter( "stepId" ) == null ) {
      ...
      try {
        ...
        log.logError( "Unable to instantiate plugin for use with GetRegisteredStepsServlet " + pluginInterface.getName() );
