...
public class CliConfigCommandHandler {
  ...
  private void printAvailableKeys() {
    ...
    print( "    \"os\"   - OS-backed encrypted store (Windows DPAPI / macOS Keychain / Linux Secret Service)." );
    print( "    \"file\" - POSIX 600 plaintext file (~/.kettle/.kettle-sessions). Use when corporate" );
    print( "             policy blocks DPAPI or keychain tools." );
    print( "    Default: os" );
    print( "    Example: file" );
    print( "" );
