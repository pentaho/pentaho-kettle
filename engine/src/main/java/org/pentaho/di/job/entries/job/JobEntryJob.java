...
public class JobEntryJob extends JobEntryBase implements Cloneable, JobEntryInterface, HasRepositoryDirectories, JobEntryRunConfigurableInterface {
  ...
  private boolean shouldConsiderOldBehaviourForEveryInputRow( ) {
    String executeWithZeroRows =  System.getProperty( Const.KETTLE_COMPATIBILITY_JOB_EXECUTE_FOR_EVERY_ROW_ON_NO_INPUT );
    boolean shouldExecuteWithZeroRows = "Y".equalsIgnoreCase( executeWithZeroRows );
    String executeWithZeroRowsCompat = System.getProperty( Const.COMPATIBILITY_JOB_EXECUTE_FOR_EVERY_ROW_ON_NO_INPUT );
    ...
    return "Y".equalsIgnoreCase( System.getProperty( Const.KETTLE_COMPATIBILITY_JOB_EXECUTE_FOR_EVERY_ROW_ON_NO_INPUT, "N" ) );
  }
