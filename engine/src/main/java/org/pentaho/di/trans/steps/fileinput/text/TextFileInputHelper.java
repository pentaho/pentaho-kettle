...
public class TextFileInputHelper extends BaseStepHelper {
  ...
  private JSONObject populateMeta( TransMeta transMeta, TextFileInputMeta meta, Map<String, String> queryParams ) {
    ...
    try {
      ...
      if ( fileInputStream == null ) {
        throw new TextFileInputException( "Header file input stream is null" );
      }
 ...
 throws IOException {
  ...
  /**
   * Dedicated exception for TextFileInput helper errors. Nested to keep everything in this helper class.
   */
  public static class TextFileInputException extends KettleException {
    public TextFileInputException( String message ) {
      super( message );
    }
  }
}
