 ...
 @SuppressWarnings( "java:S1144" ) // Using reflection this method is being invoked
  public JSONObject getSQLAction( Map<String, String> queryParams ) {
    ...
    try {
      ...
      StepMeta stepInfo = new StepMeta( BaseMessages.getString( PKG, "UpdateDialog.StepMeta.Title" ), updateMeta.getParentStepMeta().getName(), updateMeta );
      ...
      if ( sql.hasSQL() ) {
        ...
        response.put( StepInterface.ACTION_STATUS, StepInterface.FAILURE_RESPONSE );
        response.put( "errorMessage", BaseMessages.getString( PKG, "UpdateDialog.NoSQLNeeds.DialogMessage" ) );
        return response;
      }
