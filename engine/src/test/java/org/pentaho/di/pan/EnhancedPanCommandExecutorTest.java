...
public class EnhancedPanCommandExecutorTest {
  ...
  private EnhancedPanCommandExecutor mockedPanCommandExecutor;
  ...
  public void setUp() throws Exception {
    ...
    mockedPanCommandExecutor = mock( EnhancedPanCommandExecutor.class );
  ...
  public void testExecuteWithInvalidRepository() {
    try ( MockedStatic<BaseMessages> baseMessagesMockedStatic = mockStatic( BaseMessages.class ) ) {
      ...
      EnhancedPanCommandExecutor panCommandExecutor = new EnhancedPanCommandExecutor( Kitchen.class, log );
  ...
  public void testNoTransformationFinishExtensionPointCalled() throws Throwable {
    ...
    EnhancedPanCommandExecutor panCommandExecutor = new EnhancedPanCommandExecutor( EnhancedPanCommandExecutor.class, log );
