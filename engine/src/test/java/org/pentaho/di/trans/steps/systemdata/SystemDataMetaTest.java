...
public class SystemDataMetaTest implements InitializerInterface<StepMetaInterface> {
  ...
  public void setUp() throws Exception {
    ...
    names[1] = "hostname";
    types[0] = SystemDataTypes.getTypeFromString( SystemDataTypes.HOSTNAME_REAL.getDescription() );
    types[1] = SystemDataTypes.getTypeFromString( SystemDataTypes.HOSTNAME.getDescription() );
  }
