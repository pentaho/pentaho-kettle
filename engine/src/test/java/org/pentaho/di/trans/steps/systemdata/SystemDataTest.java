...
public class SystemDataTest {
  ...
  public void testProcessRow() throws Exception {
    ...
    types[0] = SystemDataTypes.getTypeFromString( SystemDataTypes.HOSTNAME.getDescription() );
    types[1] = SystemDataTypes.getTypeFromString( SystemDataTypes.HOSTNAME_REAL.getDescription() );
