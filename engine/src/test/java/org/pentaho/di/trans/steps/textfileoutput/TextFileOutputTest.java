 ...
 *
 * Copyright (C) 2002-201 by Hitachi Vantara : http://www.pentaho.com
 *
 *******************************************************************************
 *
...
public class TextFileOutputTest {
  ...
  public void testProcessRule_2() throws Exception {
    ...
    File cleanupFile = new File( TEXT_FILE_OUTPUT_PREFIX + TEXT_FILE_OUTPUT_EXTENSION );
    if ( Const.isWindows() ) {
      cleanupFile.deleteOnExit();
    } else {
      Files.deleteIfExists( cleanupFile.toPath() );
    }
  }
