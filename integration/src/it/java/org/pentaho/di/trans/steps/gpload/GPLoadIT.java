...
/* Copyright (c) 2007 - 2026 Pentaho.  All rights reserved. 
...
public class GPLoadIT {
  ...
  private static final String YAML_TEST_FILE_LOCATION = "src/it/resources";
  ...
  public void init() {
    ...
    testDirectory = new File( GPLoadIT.YAML_TEST_FILE_LOCATION );
    if ( !testDirectory.isDirectory() ) {
      fail( GPLoadIT.YAML_TEST_FILE_LOCATION + " does not exist." );
    }
  ...
  public void testInsert1() throws Exception {
    ...
    GPLoadMeta gpLoadMeta =
      createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_INSERT, GPLoadIT.TARGET_TABLE,
        GPLoadIT.GPLOAD_ERROR_TABLE, GPLoadIT.INSERT_DATA_FILE, ";", new String[0], new boolean[0],
  ...
  public void testSchemaNameSpecified() throws Exception {
    ...
    // and specifying to columns
    GPLoadMeta gpLoadMeta =
      createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_INSERT, GPLoadIT.SCHEMA_NAME, GPLoadIT.TARGET_TABLE,
        GPLoadIT.GPLOAD_ERROR_TABLE, GPLoadIT.INSERT_DATA_FILE, ";", new String[0], new boolean[0],
        new boolean[0], null, null, // no local host port or localhosts
        null, null );
  ...
  public void testUpdate1() throws Exception {
    ...
    // and specifying to columns
    GPLoadMeta gpLoadMeta =
      createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_UPDATE, GPLoadIT.TARGET_TABLE,
        GPLoadIT.GPLOAD_ERROR_TABLE, GPLoadIT.UPDATE_DATA_FILE, ";", TABLE_FIELD, matchColumn, updateColumn,
  ...
  public void testUpdate2() throws Exception {
    ...
    GPLoadMeta gpLoadMeta =
      createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_UPDATE, GPLoadIT.TARGET_TABLE,
        GPLoadIT.GPLOAD_ERROR_TABLE, GPLoadIT.UPDATE_DATA_FILE, ",", TABLE_FIELD, null, updateColumn, null,
  ...
  public void testUpdate3() throws Exception {
    ...
    GPLoadMeta gpLoadMeta =
      createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_UPDATE, GPLoadIT.TARGET_TABLE,
        GPLoadIT.GPLOAD_ERROR_TABLE, GPLoadIT.UPDATE_DATA_FILE, ",", TABLE_FIELD, matchColumn, null, null,
        null, // no local host port or localhosts);
        null, null );
  ...
  public void testUpdate4() throws Exception {
    ...
    GPLoadMeta gpLoadMeta =
      createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_UPDATE, GPLoadIT.TARGET_TABLE,
        GPLoadIT.GPLOAD_ERROR_TABLE, GPLoadIT.UPDATE_DATA_FILE,
  ...
  public void testUpdate6() throws Exception {
    ...
    // and specifying to columns
    GPLoadMeta gpLoadMeta =
      createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_UPDATE, null, GPLoadIT.GPLOAD_ERROR_TABLE,
        GPLoadIT.UPDATE_DATA_FILE, ";", TABLE_FIELD, matchColumn, updateColumn, null, null, // no local host port
                                                                                              // or localhosts);
        null, null );
  ...
  public void testMerge1() throws Exception {
    ...
    // and specifying to columns
    GPLoadMeta gpLoadMeta =
      createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_MERGE, GPLoadIT.TARGET_TABLE,
        GPLoadIT.GPLOAD_ERROR_TABLE, GPLoadIT.MERGE_DATA_FILE, ",", TABLE_FIELD, matchColumn, updateColumn,
        null, null, // no local host port or localhosts);
        null, null );
  ...
  public void testCommandLine1() throws Exception {
    ...
    GPLoadMeta gpLoadMeta =
      createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_INSERT, GPLoadIT.TARGET_TABLE,
        GPLoadIT.GPLOAD_ERROR_TABLE, GPLoadIT.INSERT_DATA_FILE, ",", pathToGPLoadExecutable, pathToControlFile,
  ...
  public void testCommandLine2() throws Exception {
    ...
    GPLoadMeta gpLoadMeta =
      createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_INSERT, GPLoadIT.TARGET_TABLE,
        GPLoadIT.GPLOAD_ERROR_TABLE, GPLoadIT.INSERT_DATA_FILE, ",", pathToGPLoadExecutable, null, null,
  ...
  public void testCommandLine4() throws Exception {
    ...
    GPLoadMeta gpLoadMeta =
      createGPLoadMeta( gpLoadStepname, GPLoadMeta.ACTION_INSERT, GPLoadIT.TARGET_TABLE,
        GPLoadIT.GPLOAD_ERROR_TABLE, GPLoadIT.INSERT_DATA_FILE, ",", invalidPath, null, null, new String[0],
