...
//	private static Class<?> PKG = Repository.class; // for i18n purposes, needed by Translator2!!   $NON-NLS-1$
	...
	public Repository(RepositoryMeta repositoryMeta, UserInfo userinfo)
	{
    ...
    public TransMeta loadTransformation(String transname, RepositoryDirectory repdir, ProgressMonitorListener monitor) throws KettleException {
    	return loadTransformation(transname, repdir, monitor, true);
    }

    public TransMeta loadTransformation(String transname, RepositoryDirectory repdir, boolean setInternalVariables) throws KettleException {
    	return loadTransformation(transname, repdir, null, setInternalVariables);
    }
    
	public boolean existsTransformation(String transname, RepositoryDirectory directory) throws KettleException {
		return transDelegate.existsTransMeta(transname, directory);
	}
    
    public TransMeta loadTransformation(String transname, RepositoryDirectory repdir) throws KettleException {
    	return loadTransformation(transname, repdir, null, true);
    }
    ...
    public void saveStepErrorMeta(StepErrorMeta meta, long id_transformation, long id_step) throws KettleException {
    	stepDelegate.saveStepErrorMeta(meta, id_transformation, id_step);
    }
    ...
    public StepErrorMeta loadStepErrorMeta(VariableSpace variables, StepMeta stepMeta, List<StepMeta> steps) throws KettleException {
    	return stepDelegate.loadStepErrorMeta(variables, stepMeta, steps);
    }
	...
	{
		RowMetaAndData result = connectionDelegate.getOneRow("SELECT "+quote(Repository.FIELD_DIRECTORY_ID_DIRECTORY)+" FROM "+quoteTable(Repository.TABLE_R_DIRECTORY)+" WHERE "+quote(Repository.FIELD_DIRECTORY_ID_DIRECTORY_PARENT)+" = 0");
    ...
    public synchronized long insertLogEntry(String description) throws KettleException
    {
        ...
        table.addValue(new ValueMeta(Repository.FIELD_REPOSITORY_LOG_ID_REPOSITORY_LOG, ValueMetaInterface.TYPE_INTEGER), new Long(id));
        table.addValue(new ValueMeta(Repository.FIELD_REPOSITORY_LOG_REP_VERSION, ValueMetaInterface.TYPE_STRING), getVersion());
        table.addValue(new ValueMeta(Repository.FIELD_REPOSITORY_LOG_LOG_DATE, ValueMetaInterface.TYPE_DATE), new Date());
        table.addValue(new ValueMeta(Repository.FIELD_REPOSITORY_LOG_LOG_USER, ValueMetaInterface.TYPE_STRING), userinfo!=null?userinfo.getLogin():"admin");
        table.addValue(new ValueMeta(Repository.FIELD_REPOSITORY_LOG_OPERATION_DESC, ValueMetaInterface.TYPE_STRING), description);

        connectionDelegate.insertTableRow(Repository.TABLE_R_REPOSITORY_LOG, table);
	...
	public synchronized void insertTransNote(long id_transformation, long id_note) throws KettleException
	{
		...
		table.addValue(new ValueMeta(Repository.FIELD_TRANS_NOTE_ID_TRANSFORMATION, ValueMetaInterface.TYPE_INTEGER), new Long(id_transformation));
		table.addValue(new ValueMeta(Repository.FIELD_TRANS_NOTE_ID_NOTE, ValueMetaInterface.TYPE_INTEGER), new Long(id_note));

		connectionDelegate.insertTableRow(Repository.TABLE_R_TRANS_NOTE, table);
	}
	...
	public synchronized void insertJobNote(long id_job, long id_note) throws KettleException
	{
		...
		table.addValue(new ValueMeta(Repository.FIELD_JOB_NOTE_ID_JOB, ValueMetaInterface.TYPE_INTEGER), new Long(id_job));
		table.addValue(new ValueMeta(Repository.FIELD_JOB_NOTE_ID_NOTE, ValueMetaInterface.TYPE_INTEGER), new Long(id_note));

		connectionDelegate.insertTableRow(Repository.TABLE_R_JOB_NOTE, table);
	}
			...
			throws KettleException
	{
		...
		if (check.getInteger(0) == null)
		{
			...
			table.addValue(new ValueMeta(Repository.FIELD_STEP_DATABASE_ID_TRANSFORMATION, ValueMetaInterface.TYPE_INTEGER), new Long(id_transformation));
			table.addValue(new ValueMeta(Repository.FIELD_STEP_DATABASE_ID_STEP, ValueMetaInterface.TYPE_INTEGER), new Long(id_step));
			table.addValue(new ValueMeta(Repository.FIELD_STEP_DATABASE_ID_DATABASE, ValueMetaInterface.TYPE_INTEGER), new Long(id_database));

			connectionDelegate.insertTableRow(Repository.TABLE_R_STEP_DATABASE, table);
		}
	}
	...
	throws KettleException
	{
		...
		if (check.getInteger(0) == null)
		{
			...
			table.addValue(new ValueMeta(Repository.FIELD_JOBENTRY_DATABASE_ID_JOB, ValueMetaInterface.TYPE_INTEGER), new Long(id_job));
			table.addValue(new ValueMeta(Repository.FIELD_JOBENTRY_DATABASE_ID_JOBENTRY, ValueMetaInterface.TYPE_INTEGER), new Long(id_jobentry));
			table.addValue(new ValueMeta(Repository.FIELD_JOBENTRY_DATABASE_ID_DATABASE, ValueMetaInterface.TYPE_INTEGER), new Long(id_database));

			connectionDelegate.insertTableRow(Repository.TABLE_R_JOBENTRY_DATABASE, table);
		}
	}
    ...
    public synchronized long insertTransformationPartitionSchema(long id_transformation, long id_partition_schema) throws KettleException
    {
        ...
        table.addValue(new ValueMeta(Repository.FIELD_TRANS_PARTITION_SCHEMA_ID_TRANS_PARTITION_SCHEMA, ValueMetaInterface.TYPE_INTEGER), new Long(id));
        table.addValue(new ValueMeta(Repository.FIELD_TRANS_PARTITION_SCHEMA_ID_TRANSFORMATION, ValueMetaInterface.TYPE_INTEGER), new Long(id_transformation));
        table.addValue(new ValueMeta(Repository.FIELD_TRANS_PARTITION_SCHEMA_ID_PARTITION_SCHEMA, ValueMetaInterface.TYPE_INTEGER), new Long(id_partition_schema));

        connectionDelegate.insertTableRow(Repository.TABLE_R_TRANS_PARTITION_SCHEMA, table);
    ...
    public synchronized long insertClusterSlave(ClusterSchema clusterSchema, SlaveServer slaveServer) throws KettleException
    {
        ...
        table.addValue(new ValueMeta(Repository.FIELD_CLUSTER_SLAVE_ID_CLUSTER_SLAVE, ValueMetaInterface.TYPE_INTEGER), new Long(id));
        table.addValue(new ValueMeta(Repository.FIELD_CLUSTER_SLAVE_ID_CLUSTER, ValueMetaInterface.TYPE_INTEGER), new Long(clusterSchema.getId()));
        table.addValue(new ValueMeta(Repository.FIELD_CLUSTER_SLAVE_ID_SLAVE, ValueMetaInterface.TYPE_INTEGER), new Long(slaveServer.getID()));

        connectionDelegate.insertTableRow(Repository.TABLE_R_CLUSTER_SLAVE, table);
    ...
    public synchronized long insertTransformationCluster(long id_transformation, long id_cluster) throws KettleException
    {
        ...
        table.addValue(new ValueMeta(Repository.FIELD_TRANS_CLUSTER_ID_TRANS_CLUSTER, ValueMetaInterface.TYPE_INTEGER), new Long(id));
        table.addValue(new ValueMeta(Repository.FIELD_TRANS_CLUSTER_ID_TRANSFORMATION, ValueMetaInterface.TYPE_INTEGER), new Long(id_transformation));
        table.addValue(new ValueMeta(Repository.FIELD_TRANS_CLUSTER_ID_CLUSTER, ValueMetaInterface.TYPE_INTEGER), new Long(id_cluster));

        connectionDelegate.insertTableRow(Repository.TABLE_R_TRANS_CLUSTER, table);
    ...
    public synchronized long insertTransformationSlave(long id_transformation, long id_slave) throws KettleException
    {
        ...
        table.addValue(new ValueMeta(Repository.FIELD_TRANS_SLAVE_ID_TRANS_SLAVE, ValueMetaInterface.TYPE_INTEGER), new Long(id));
        table.addValue(new ValueMeta(Repository.FIELD_TRANS_SLAVE_ID_TRANSFORMATION, ValueMetaInterface.TYPE_INTEGER), new Long(id_transformation));
        table.addValue(new ValueMeta(Repository.FIELD_TRANS_SLAVE_ID_SLAVE, ValueMetaInterface.TYPE_INTEGER), new Long(id_slave));

        connectionDelegate.insertTableRow(Repository.TABLE_R_TRANS_SLAVE, table);
	...
	public synchronized void insertTransStepCondition(long id_transformation, long id_step, long id_condition)
			throws KettleException
	{
		String tablename = Repository.TABLE_R_TRANS_STEP_CONDITION;
		RowMetaAndData table = new RowMetaAndData();
		table.addValue(new ValueMeta(Repository.FIELD_TRANS_STEP_CONDITION_ID_TRANSFORMATION, ValueMetaInterface.TYPE_INTEGER), new Long(id_transformation));
		table.addValue(new ValueMeta(Repository.FIELD_TRANS_STEP_CONDITION_ID_STEP, ValueMetaInterface.TYPE_INTEGER), new Long(id_step));
		table.addValue(new ValueMeta(Repository.FIELD_TRANS_STEP_CONDITION_ID_CONDITION, ValueMetaInterface.TYPE_INTEGER), new Long(id_condition));
	...
	{
		return connectionDelegate.getStrings("SELECT "+quote(Repository.FIELD_TRANSFORMATION_NAME)+" FROM "+quoteTable(Repository.TABLE_R_TRANSFORMATION)+" WHERE "+quote(Repository.FIELD_TRANSFORMATION_ID_DIRECTORY)+" = " + id_directory + " ORDER BY "+quote(Repository.FIELD_TRANSFORMATION_NAME));
	}
    
    public List<RepositoryObject> getJobObjects(long id_directory) throws KettleException
    {
        return getRepositoryObjects(quoteTable(Repository.TABLE_R_JOB), RepositoryObject.STRING_OBJECT_TYPE_JOB, id_directory);
    }

    public List<RepositoryObject> getTransformationObjects(long id_directory) throws KettleException
    {
        return getRepositoryObjects(quoteTable(Repository.TABLE_R_TRANSFORMATION), RepositoryObject.STRING_OBJECT_TYPE_TRANSFORMATION, id_directory);
    }
	...
	{
        return connectionDelegate.getStrings("SELECT "+quote(Repository.FIELD_JOB_NAME)+" FROM "+quoteTable(Repository.TABLE_R_JOB)+" WHERE "+quote(Repository.FIELD_JOB_ID_DIRECTORY)+" = " + id_directory + " ORDER BY "+quote(Repository.FIELD_JOB_NAME));
	}

	public synchronized String[] getDirectoryNames(long id_directory) throws KettleException
	{
        return connectionDelegate.getStrings("SELECT "+quote(Repository.FIELD_DIRECTORY_DIRECTORY_NAME)+" FROM "+quoteTable(Repository.TABLE_R_DIRECTORY)+" WHERE "+quote(Repository.FIELD_DIRECTORY_ID_DIRECTORY_PARENT)+" = " + id_directory + " ORDER BY "+quote(Repository.FIELD_DIRECTORY_DIRECTORY_NAME));
	}

	public synchronized String[] getJobNames() throws KettleException
	{
        return connectionDelegate.getStrings("SELECT "+quote(Repository.FIELD_JOB_NAME)+" FROM "+quoteTable(Repository.TABLE_R_JOB)+" ORDER BY "+quote(Repository.FIELD_JOB_NAME));
	}

	public long[] getSubConditionIDs(long id_condition) throws KettleException
	{
        return connectionDelegate.getIDs("SELECT "+quote(Repository.FIELD_CONDITION_ID_CONDITION)+" FROM "+quoteTable(Repository.TABLE_R_CONDITION)+" WHERE "+quote(Repository.FIELD_CONDITION_ID_CONDITION_PARENT)+" = " + id_condition);
	}

	public long[] getTransNoteIDs(long id_transformation) throws KettleException
	{
        return connectionDelegate.getIDs("SELECT "+quote(Repository.FIELD_TRANS_NOTE_ID_NOTE)+" FROM "+quoteTable(Repository.TABLE_R_TRANS_NOTE)+" WHERE "+quote(Repository.FIELD_TRANS_NOTE_ID_TRANSFORMATION)+" = " + id_transformation);
	}

	public long[] getConditionIDs(long id_transformation) throws KettleException
	{
        return connectionDelegate.getIDs("SELECT "+quote(Repository.FIELD_TRANS_STEP_CONDITION_ID_CONDITION)+" FROM "+quoteTable(Repository.TABLE_R_TRANS_STEP_CONDITION)+" WHERE "+quote(Repository.FIELD_TRANS_STEP_CONDITION_ID_TRANSFORMATION)+" = " + id_transformation);
	}

	public long[] getDatabaseIDs(long id_transformation) throws KettleException
	{
        return connectionDelegate.getIDs("SELECT "+quote(Repository.FIELD_STEP_DATABASE_ID_DATABASE)+" FROM "+quoteTable(Repository.TABLE_R_STEP_DATABASE)+" WHERE "+quote(Repository.FIELD_STEP_DATABASE_ID_TRANSFORMATION)+" = " + id_transformation);
	}

	public long[] getJobNoteIDs(long id_job) throws KettleException
	{
        return connectionDelegate.getIDs("SELECT "+quote(Repository.FIELD_JOB_NOTE_ID_NOTE)+" FROM "+quoteTable(Repository.TABLE_R_JOB_NOTE)+" WHERE "+quote(Repository.FIELD_JOB_NOTE_ID_JOB)+" = " + id_job);
	}

	public long[] getDatabaseIDs() throws KettleException
	{
        return connectionDelegate.getIDs("SELECT "+quote(Repository.FIELD_DATABASE_ID_DATABASE)+" FROM "+quoteTable(Repository.TABLE_R_DATABASE)+" ORDER BY "+quote(Repository.FIELD_DATABASE_ID_DATABASE));
	}
    
    public long[] getDatabaseAttributeIDs(long id_database) throws KettleException
    {
        return connectionDelegate.getIDs("SELECT "+quote(Repository.FIELD_DATABASE_ATTRIBUTE_ID_DATABASE_ATTRIBUTE)+" FROM "+quoteTable(Repository.TABLE_R_DATABASE_ATTRIBUTE)+" WHERE "+quote(Repository.FIELD_DATABASE_ATTRIBUTE_ID_DATABASE)+" = "+id_database);
    }
    
    public long[] getPartitionSchemaIDs() throws KettleException
    {
        return connectionDelegate.getIDs("SELECT "+quote(Repository.FIELD_PARTITION_SCHEMA_ID_PARTITION_SCHEMA)+" FROM "+quoteTable(Repository.TABLE_R_PARTITION_SCHEMA)+" ORDER BY "+quote(Repository.FIELD_PARTITION_SCHEMA_NAME));
    }
    
    public long[] getPartitionIDs(long id_partition_schema) throws KettleException
    {
        return connectionDelegate.getIDs("SELECT "+quote(Repository.FIELD_PARTITION_ID_PARTITION)+" FROM "+quoteTable(Repository.TABLE_R_PARTITION)+" WHERE "+quote(Repository.FIELD_PARTITION_ID_PARTITION_SCHEMA)+" = " + id_partition_schema);
    }

    public long[] getTransformationPartitionSchemaIDs(long id_transformation) throws KettleException
    {
        return connectionDelegate.getIDs("SELECT "+quote(Repository.FIELD_TRANS_PARTITION_SCHEMA_ID_TRANS_PARTITION_SCHEMA)+" FROM "+quoteTable(Repository.TABLE_R_TRANS_PARTITION_SCHEMA)+" WHERE "+quote(Repository.FIELD_TRANS_PARTITION_SCHEMA_ID_TRANSFORMATION)+" = "+id_transformation);
    }
    
    public long[] getTransformationClusterSchemaIDs(long id_transformation) throws KettleException
    {
        return connectionDelegate.getIDs("SELECT ID_TRANS_CLUSTER FROM "+quoteTable(Repository.TABLE_R_TRANS_CLUSTER)+" WHERE ID_TRANSFORMATION = " + id_transformation);
    }
    
    public long[] getClusterIDs() throws KettleException
    {
        return connectionDelegate.getIDs("SELECT "+quote(Repository.FIELD_CLUSTER_ID_CLUSTER)+" FROM "+quoteTable(Repository.TABLE_R_CLUSTER)+" ORDER BY "+quote(Repository.FIELD_CLUSTER_NAME)); 
    }

    public long[] getSlaveIDs() throws KettleException
    {
        return connectionDelegate.getIDs("SELECT "+quote(Repository.FIELD_SLAVE_ID_SLAVE)+" FROM "+quoteTable(Repository.TABLE_R_SLAVE));
    }

    public long[] getSlaveIDs(long id_cluster_schema) throws KettleException
    {
        return connectionDelegate.getIDs("SELECT "+quote(Repository.FIELD_CLUSTER_SLAVE_ID_SLAVE)+" FROM "+quoteTable(Repository.TABLE_R_CLUSTER_SLAVE)+" WHERE "+quote(Repository.FIELD_CLUSTER_SLAVE_ID_CLUSTER)+" = " + id_cluster_schema);
    }
    
	public synchronized String[] getDatabaseNames() throws KettleException
	{
		String nameField = quote(Repository.FIELD_DATABASE_NAME);
		return connectionDelegate.getStrings("SELECT "+nameField+" FROM "+quoteTable(Repository.TABLE_R_DATABASE)+" ORDER BY "+nameField);
	}
    
    public synchronized String[] getPartitionSchemaNames() throws KettleException
    {
        String nameField = quote(Repository.FIELD_PARTITION_SCHEMA_NAME);
        return connectionDelegate.getStrings("SELECT "+nameField+" FROM "+quoteTable(Repository.TABLE_R_PARTITION_SCHEMA)+" ORDER BY "+nameField);
    }
    
    public synchronized String[] getSlaveNames() throws KettleException
    {
        String nameField = quote(Repository.FIELD_SLAVE_NAME);
        return connectionDelegate.getStrings("SELECT "+nameField+" FROM "+quoteTable(Repository.TABLE_R_SLAVE)+" ORDER BY "+nameField);
    }
    
    public synchronized String[] getClusterNames() throws KettleException
    {
        String nameField = quote(Repository.FIELD_CLUSTER_NAME);
        return connectionDelegate.getStrings("SELECT "+nameField+" FROM "+quoteTable(Repository.TABLE_R_CLUSTER)+" ORDER BY "+nameField);
    }

	public long[] getStepIDs(long id_transformation) throws KettleException
	{
		return connectionDelegate.getIDs("SELECT "+quote(Repository.FIELD_STEP_ID_STEP)+" FROM "+quoteTable(Repository.TABLE_R_STEP)+" WHERE "+quote(Repository.FIELD_STEP_ID_TRANSFORMATION)+" = " + id_transformation);
	}

	public synchronized String[] getTransformationsUsingDatabase(long id_database) throws KettleException
	{
		String sql = "SELECT DISTINCT "+quote(Repository.FIELD_STEP_DATABASE_ID_TRANSFORMATION)+" FROM "+quoteTable(Repository.TABLE_R_STEP_DATABASE)+" WHERE "+quote(Repository.FIELD_STEP_DATABASE_ID_DATABASE)+" = " + id_database;
	...
	{
		String sql = "SELECT DISTINCT "+quote(Repository.FIELD_JOBENTRY_DATABASE_ID_JOB)+" FROM "+quoteTable(Repository.TABLE_R_JOBENTRY_DATABASE)+" WHERE "+quote(Repository.FIELD_JOBENTRY_DATABASE_ID_DATABASE)+" = " + id_database;
    ...
    {
        String sql = "SELECT DISTINCT "+quote(Repository.FIELD_TRANS_SLAVE_ID_TRANSFORMATION)+" FROM "+quoteTable(Repository.TABLE_R_TRANS_SLAVE)+" WHERE "+quote(Repository.FIELD_TRANS_SLAVE_ID_SLAVE)+" = " + id_slave;
        return transDelegate.getTransformationsWithIDList( connectionDelegate.getRows(sql, 100), connectionDelegate.getReturnRowMeta() );
    }
    
    public synchronized String[] getTransformationsUsingPartitionSchema(long id_partition_schema) throws KettleException
    {
        String sql = "SELECT DISTINCT "+quote(Repository.FIELD_TRANS_PARTITION_SCHEMA_ID_TRANSFORMATION)+
                     " FROM "+quoteTable(Repository.TABLE_R_TRANS_PARTITION_SCHEMA)+" WHERE "+quote(Repository.FIELD_TRANS_PARTITION_SCHEMA_ID_PARTITION_SCHEMA)+" = " + id_partition_schema;
        return transDelegate.getTransformationsWithIDList( connectionDelegate.getRows(sql, 100), connectionDelegate.getReturnRowMeta() );
    }
    
    public synchronized String[] getTransformationsUsingCluster(long id_cluster) throws KettleException
    {
        String sql = "SELECT DISTINCT "+quote(Repository.FIELD_TRANS_CLUSTER_ID_TRANSFORMATION)+" FROM "+quoteTable(Repository.TABLE_R_TRANS_CLUSTER)+" WHERE "+quote(Repository.FIELD_TRANS_CLUSTER_ID_CLUSTER)+" = " + id_cluster;
        return transDelegate.getTransformationsWithIDList( connectionDelegate.getRows(sql, 100), connectionDelegate.getReturnRowMeta() );
    }
	...
	{
		return connectionDelegate.getIDs("SELECT "+quote(Repository.FIELD_JOB_HOP_ID_JOB_HOP)+" FROM "+quoteTable(Repository.TABLE_R_JOB_HOP)+" WHERE "+quote(Repository.FIELD_JOB_HOP_ID_JOB)+" = " + id_job);
	}

	public long[] getTransDependencyIDs(long id_transformation) throws KettleException
	{
		return connectionDelegate.getIDs("SELECT "+quote(Repository.FIELD_DEPENDENCY_ID_DEPENDENCY)+" FROM "+quoteTable(Repository.TABLE_R_DEPENDENCY)+" WHERE "+quote(Repository.FIELD_DEPENDENCY_ID_TRANSFORMATION)+" = " + id_transformation);
	}

	public long[] getUserIDs() throws KettleException
	{
		return connectionDelegate.getIDs("SELECT "+quote(Repository.FIELD_USER_ID_USER)+" FROM "+quoteTable(Repository.TABLE_R_USER));
	}

	public synchronized String[] getUserLogins() throws KettleException
	{
		String loginField = quote(Repository.FIELD_USER_LOGIN);
		return connectionDelegate.getStrings("SELECT "+loginField+" FROM "+quoteTable(Repository.TABLE_R_USER)+" ORDER BY "+loginField);
	}

	public long[] getPermissionIDs(long id_profile) throws KettleException
	{
		return connectionDelegate.getIDs("SELECT "+quote(Repository.FIELD_PROFILE_PERMISSION_ID_PERMISSION)+" FROM "+quoteTable(Repository.TABLE_R_PROFILE_PERMISSION)+" WHERE "+quote(Repository.FIELD_PROFILE_PERMISSION_ID_PROFILE)+" = " + id_profile);
	}

	public long[] getJobEntryIDs(long id_job) throws KettleException
	{
		return connectionDelegate.getIDs("SELECT "+quote(Repository.FIELD_JOBENTRY_ID_JOBENTRY)+" FROM "+quoteTable(Repository.TABLE_R_JOBENTRY)+" WHERE "+quote(Repository.FIELD_JOBENTRY_ID_JOB)+" = " + id_job);
	}

	public long[] getJobEntryCopyIDs(long id_job) throws KettleException
	{
		return connectionDelegate.getIDs("SELECT "+quote(Repository.FIELD_JOBENTRY_COPY_ID_JOBENTRY_COPY)+" FROM "+quoteTable(Repository.TABLE_R_JOBENTRY_COPY)+" WHERE "+quote(Repository.FIELD_JOBENTRY_COPY_ID_JOB)+" = " + id_job);
	}

	public long[] getJobEntryCopyIDs(long id_job, long id_jobentry) throws KettleException
	{
		return connectionDelegate.getIDs("SELECT "+quote(Repository.FIELD_JOBENTRY_COPY_ID_JOBENTRY_COPY)+
				" FROM "+quoteTable(Repository.TABLE_R_JOBENTRY_COPY)+" WHERE "+quote(Repository.FIELD_JOBENTRY_COPY_ID_JOB)+" = " + id_job + " AND "+quote(Repository.FIELD_JOBENTRY_COPY_ID_JOBENTRY)+" = " + id_jobentry);
	}

	public synchronized String[] getProfiles() throws KettleException
	{
		String nameField = quote(Repository.FIELD_PROFILE_NAME);
		return connectionDelegate.getStrings("SELECT "+nameField+" FROM "+quoteTable(Repository.TABLE_R_PROFILE)+" ORDER BY "+nameField);
	}

	@Deprecated
	public RowMetaAndData getStepDatabase(long id_step) throws KettleException
	{
		return connectionDelegate.getOneRow(quoteTable(Repository.TABLE_R_STEP_DATABASE), quote(Repository.FIELD_STEP_DATABASE_ID_STEP), id_step);
	}
	
	@Deprecated
	public RowMetaAndData getJobEntryDatabase(long id_jobentry) throws KettleException
	{
		return connectionDelegate.getOneRow(quoteTable(Repository.TABLE_R_JOBENTRY_DATABASE), quote(Repository.FIELD_JOBENTRY_DATABASE_ID_JOBENTRY), id_jobentry);
	}
  ...
  public static final String byteArrayToString(byte[] val) throws IOException {
	...
	{
		String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_STEP)+" WHERE "+quote(Repository.FIELD_STEP_ID_TRANSFORMATION)+" = " + id_transformation;
		execStatement(sql);
	}
	...
	public synchronized void delCondition(long id_condition) throws KettleException
	{
		...
		{
			String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_CONDITION)+" WHERE "+quote(Repository.FIELD_CONDITION_ID_CONDITION)+" = " + id_condition;
			execStatement(sql);
		}
	}
	...
	public synchronized void delStepConditions(long id_transformation) throws KettleException
	{
		...
		String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_TRANS_STEP_CONDITION)+" WHERE "+quote(Repository.FIELD_TRANS_STEP_CONDITION_ID_TRANSFORMATION)+" = " + id_transformation;
		execStatement(sql);
	}
	...
	{
		String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_STEP_DATABASE)+" WHERE "+quote(Repository.FIELD_STEP_DATABASE_ID_TRANSFORMATION)+" = " + id_transformation;
		execStatement(sql);
	}
	/**
	...
	{
		String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_JOBENTRY_DATABASE)+" WHERE "+quote(Repository.FIELD_JOBENTRY_DATABASE_ID_JOB)+" = " + id_job;
		execStatement(sql);
	}
	public synchronized void delJobEntries(long id_job) throws KettleException
	{
		String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_JOBENTRY)+" WHERE "+quote(Repository.FIELD_JOBENTRY_ID_JOB)+" = " + id_job;
		execStatement(sql);
	}

	public synchronized void delJobEntryCopies(long id_job) throws KettleException
	{
		String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_JOBENTRY_COPY)+" WHERE "+quote(Repository.FIELD_JOBENTRY_COPY_ID_JOB)+" = " + id_job;
		execStatement(sql);
	}

	public synchronized void delDependencies(long id_transformation) throws KettleException
	{
		String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_DEPENDENCY)+" WHERE "+quote(Repository.FIELD_DEPENDENCY_ID_TRANSFORMATION)+" = " + id_transformation;
		execStatement(sql);
	}

	public synchronized void delStepAttributes(long id_transformation) throws KettleException
	{
		String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_STEP_ATTRIBUTE)+" WHERE "+quote(Repository.FIELD_STEP_ATTRIBUTE_ID_TRANSFORMATION)+" = " + id_transformation;
		execStatement(sql);
	}

    public synchronized void delTransAttributes(long id_transformation) throws KettleException
    {
        String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_TRANS_ATTRIBUTE)+" WHERE "+quote(Repository.FIELD_TRANS_ATTRIBUTE_ID_TRANSFORMATION)+" = " + id_transformation;
        execStatement(sql);
    }

    public synchronized void delJobAttributes(long id_job) throws KettleException
    {
        String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_JOB_ATTRIBUTE)+" WHERE "+quote(Repository.FIELD_JOB_ATTRIBUTE_ID_JOB)+" = " + id_job;
        execStatement(sql);
    }   
    
    public synchronized void delPartitionSchemas(long id_transformation) throws KettleException
    {
        String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_TRANS_PARTITION_SCHEMA)+" WHERE "+quote(Repository.FIELD_TRANS_PARTITION_SCHEMA_ID_TRANSFORMATION)+" = " + id_transformation;
        execStatement(sql);
    }
    ...
    public synchronized void delPartitions(long id_partition_schema) throws KettleException
    {
        ...
        // 
        execStatement("DELETE FROM "+quoteTable(Repository.TABLE_R_PARTITION)+" WHERE "+quote(Repository.FIELD_PARTITION_ID_PARTITION_SCHEMA)+" = " + id_partition_schema);
    }
    
    public synchronized void delClusterSlaves(long id_cluster) throws KettleException
    {
        String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_CLUSTER_SLAVE)+" WHERE "+quote(Repository.FIELD_CLUSTER_SLAVE_ID_CLUSTER)+" = " + id_cluster;
        execStatement(sql);
    }
    
    public synchronized void delTransformationClusters(long id_transformation) throws KettleException
    {
        String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_TRANS_CLUSTER)+" WHERE "+quote(Repository.FIELD_TRANS_CLUSTER_ID_TRANSFORMATION)+" = " + id_transformation;
        execStatement(sql);
    }

    public synchronized void delTransformationSlaves(long id_transformation) throws KettleException
    {
        String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_TRANS_SLAVE)+" WHERE "+quote(Repository.FIELD_TRANS_SLAVE_ID_TRANSFORMATION)+" = " + id_transformation;
        execStatement(sql);
    }
	...
	{
		String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_JOBENTRY_ATTRIBUTE)+" WHERE "+quote(Repository.FIELD_JOBENTRY_ATTRIBUTE_ID_JOB)+" = " + id_job;
		execStatement(sql);
	}

	public synchronized void delTransHops(long id_transformation) throws KettleException
	{
		String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_TRANS_HOP)+" WHERE "+quote(Repository.FIELD_TRANS_HOP_ID_TRANSFORMATION)+" = " + id_transformation;
		execStatement(sql);
	}

	public synchronized void delJobHops(long id_job) throws KettleException
	{
		String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_JOB_HOP)+" WHERE "+quote(Repository.FIELD_JOB_HOP_ID_JOB)+" = " + id_job;
		execStatement(sql);
	}
	...
	public synchronized void delTransNotes(long id_transformation) throws KettleException
	{
		...
		for (int i = 0; i < ids.length; i++)
		{
			String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_NOTE)+" WHERE "+quote(Repository.FIELD_NOTE_ID_NOTE)+" = " + ids[i];
			execStatement(sql);
		}

		String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_TRANS_NOTE)+" WHERE "+quote(Repository.FIELD_TRANS_NOTE_ID_TRANSFORMATION)+" = " + id_transformation;
		execStatement(sql);
	}
	...
	public synchronized void delJobNotes(long id_job) throws KettleException
	{
		...
		String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_JOB_NOTE)+" WHERE "+quote(Repository.FIELD_JOB_NOTE_ID_JOB)+" = " + id_job;
		execStatement(sql);
	}

	public synchronized void delTrans(long id_transformation) throws KettleException
	{
		String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_TRANSFORMATION)+" WHERE "+quote(Repository.FIELD_TRANSFORMATION_ID_TRANSFORMATION)+" = " + id_transformation;
		execStatement(sql);
	}

	public synchronized void delJob(long id_job) throws KettleException
	{
		String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_JOB)+" WHERE "+quote(Repository.FIELD_JOB_ID_JOB)+" = " + id_job;
		execStatement(sql);
	}
	...
	{
		String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_VALUE)+" WHERE "+quote(Repository.FIELD_VALUE_ID_VALUE)+" = " + id_value;
		execStatement(sql);
	}

	public synchronized void delUser(long id_user) throws KettleException
	{
		String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_USER)+" WHERE "+quote(Repository.FIELD_USER_ID_USER)+" = " + id_user;
		execStatement(sql);
	}

	public synchronized void delProfile(long id_profile) throws KettleException
	{
		String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_PROFILE)+" WHERE "+quote(Repository.FIELD_PROFILE_ID_PROFILE)+" = " + id_profile;
		execStatement(sql);
	}

	public synchronized void delProfilePermissions(long id_profile) throws KettleException
	{
		String sql = "DELETE FROM "+quoteTable(Repository.TABLE_R_PROFILE_PERMISSION)+" WHERE "+quote(Repository.FIELD_PROFILE_PERMISSION_ID_PROFILE)+" = " + id_profile;
		execStatement(sql);
	}
    ...
    public synchronized void delSlave(long id_slave) throws KettleException
    {
        ...
        {
            execStatement("DELETE FROM "+quoteTable(Repository.TABLE_R_SLAVE)+" WHERE "+quote(Repository.FIELD_SLAVE_ID_SLAVE)+" = " + id_slave);
            execStatement("DELETE FROM "+quoteTable(Repository.TABLE_R_TRANS_SLAVE)+" WHERE "+quote(Repository.FIELD_TRANS_SLAVE_ID_SLAVE)+" = " + id_slave);
        }
        else
        {
