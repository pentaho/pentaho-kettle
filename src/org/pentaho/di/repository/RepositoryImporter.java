...
public class RepositoryImporter implements ProgressMonitorListener, RepositoryImportFeedbackInterface, RepositoryElementReadListener {
   ...
   * @param filename The export file to import
   * @param baseDirectory The directory to import into
   * @param overwrite Overwrite existing objects?
   * @param continueOnError Continue on error?
   * @param versionComment The version comment for the repositories that support this.
   */
