...
//	private static Class<?> PKG = UserInfo.class; // for i18n purposes, needed by Translator2!!   $NON-NLS-1$
	...
	public UserInfo(String login, String password, String username, String description, boolean enabled, ProfileMeta profile)
	{
		this.login = login;
	 ...
	 * @param name The name of the user maps to the login id. 
	 */
