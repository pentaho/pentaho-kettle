...
//	private static Class<?> PKG = Repository.class; // for i18n purposes, needed by Translator2!!   $NON-NLS-1$
	...
	protected RepositoryDirectory	directoryTree;
    ...
    protected RepositoryCreationHelper creationHelper;

	
	public BaseRepository(RepositoryMeta repositoryMeta, UserInfo userinfo)
	{
