...
public class XMLOutputMeta extends BaseStepMeta implements StepMetaInterface
{
	...
	public void readRep(Repository rep, long id_step, List<? extends SharedObjectInterface> databases,
	...
	public void saveRep(Repository rep, long id_transformation, long id_step) throws KettleException
	{
		try
		{
			...
			for (int i = 0; i < outputFields.length; i++)
			{
				...
				rep.saveStepAttribute(id_transformation, id_step, i, "field_decimal", field
						.getDecimalSymbol());
				rep
						.saveStepAttribute(id_transformation, id_step, i, "field_group", field
								.getGroupingSymbol());
		...
		{
			throw new KettleException("Unable to save step information to the repository for id_step="
					+ id_step, e);
		}
	}
