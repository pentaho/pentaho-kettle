...
public class FixedInputMetaInjection implements StepMetaInjectionInterface {
  ...
  public void injectStepMetadataEntries(List<StepInjectionMetaEntry> all) throws KettleException {
    ...
    for (StepInjectionMetaEntry lookFields : all) {
      ...
      if (fieldsEntry!=null) {
              ...
              if (fieldEntry == Entry.FIELD) {
                ...
                for (StepInjectionMetaEntry entry : entries) {
                  ...
                  if (metaEntry!=null) {
                    ...
                    case WIDTH:     inputField.setWidth(Const.toInt(value, -1)); break;
                    ...
                    case CURRENCY:  inputField.setCurrency(value); break;
                    case GROUP:     inputField.setGrouping(value); break;
        ...
        case LINE_WIDTH: meta.setLineWidth(lookValue); break;
        case BUFFER_SIZE: meta.setBufferSize(lookValue); break;
        case LAZY_CONVERSION_ACTIVE: meta.setLazyConversionActive("Y".equalsIgnoreCase(lookValue)); break;
        case LINE_FEED_PRESENT: meta.setLineFeedPresent("Y".equalsIgnoreCase(lookValue)); break;
  ...
  private enum Entry {
    ...
    FIELDS(ValueMetaInterface.TYPE_NONE, "All the data fields in the fixed width file"),
    FIELD(ValueMetaInterface.TYPE_NONE, "One data field"),

    NAME(FIELD, ValueMetaInterface.TYPE_STRING, "Field name"),
    TYPE(FIELD, ValueMetaInterface.TYPE_STRING, "Field data type"),
    WIDTH(FIELD, ValueMetaInterface.TYPE_STRING, "Field width"),
    ...
    FILENAME(ValueMetaInterface.TYPE_STRING, "Filename"),
    HEADER_PRESENT(ValueMetaInterface.TYPE_STRING, "Header present? (Y/N)"),
    LINE_WIDTH(ValueMetaInterface.TYPE_STRING, "The line width"),
    BUFFER_SIZE(ValueMetaInterface.TYPE_STRING, "The buffer size"),
    LAZY_CONVERSION_ACTIVE(ValueMetaInterface.TYPE_STRING, "Lazy conversion active? (Y/N)"),
    LINE_FEED_PRESENT(ValueMetaInterface.TYPE_STRING, "Line feed present? (Y/N)"),
    RUNNING_IN_PARALLEL(ValueMetaInterface.TYPE_STRING, "Running in parallel? (Y/N)"),
    FILE_TYPE_CODE(ValueMetaInterface.TYPE_STRING, "File type code (NONE, UNIX, DOS)"),
    ADD_TO_RESULT(ValueMetaInterface.TYPE_STRING, "Add filename to result? (Y/N)"),
    ;
