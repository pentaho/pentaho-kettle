...
public class DenormaliserMetaInjection implements StepMetaInjectionInterface {
              ...
              if (fieldEntry == Entry.FIELD) {
                ...
                for (StepInjectionMetaEntry entry : entries) {
                  ...
                  if (metaEntry!=null) {
                    ...
                    switch(metaEntry) {
                    case NAME:               inputField.setFieldName(value); break;
                    case KEY_VALUE:          inputField.setKeyValue(value); break;
                    case TARGET_NAME:        inputField.setTargetName(value); break;
                    case TARGET_TYPE:        inputField.setTargetType( ValueMeta.getType(value) ); break;
                    case TARGET_LENGTH:      inputField.setTargetLength(Const.toInt(value, -1)); break;
                    case TARGET_PRECISION:   inputField.setTargetPrecision(Const.toInt(value, -1)); break;
                    case TARGET_CURRENCY:    inputField.setTargetCurrencySymbol(value); break;
                    case TARGET_GROUP:       inputField.setTargetGroupingSymbol(value); break;
  ...
  private enum Entry {
    ...
    TARGET_AGGREGATION(ValueMetaInterface.TYPE_STRING, "Target aggregation (-, SUM, AVERAGE, MIN, MAX, COUNT_ALL, CONCAT_COMMA)"),
    ;
