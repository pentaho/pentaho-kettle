...
public class JavaFilterMetaFunction implements Cloneable
{
     ...
     */
    public JavaFilterMetaFunction(String fieldName, String formula, int valueType, int valueLength, int valuePrecision, String replaceField)
    {
    ...
    {       
        ...
        {
        	JavaFilterMetaFunction mf = (JavaFilterMetaFunction)obj;
    ...
    public Object clone()
    {
        try
        {
            JavaFilterMetaFunction retval = (JavaFilterMetaFunction) super.clone();
            return retval;
        }
    ...
    public JavaFilterMetaFunction(Node calcnode)
    {
    ...
    public JavaFilterMetaFunction(Repository rep, ObjectId id_step, int nr) throws KettleException
    {
