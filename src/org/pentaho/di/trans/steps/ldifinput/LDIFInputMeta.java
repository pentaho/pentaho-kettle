	    ...
	    throws KettleXMLException
{
    ...
    throws KettleException
   {
	...
	{
        return FileInputList.createFileList(space,space.environmentSubstitute(fileName), space.environmentSubstitute(fileMask), fileRequired, includeSubFolderBoolean());
	}
