...
public class TableExists extends BaseStep implements StepInterface
{
    ...
    public void run()
    {
    	if(log.isBasic()) logBasic(Messages.getString("TableExists.Log.StartingToRun")); //$NON-NLS-1$
        ...
        {
            logError(Messages.getString("TableExists.Log.UnexpectedError")+" : "+e.toString()); //$NON-NLS-1$ //$NON-NLS-2$
