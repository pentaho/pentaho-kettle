...
public class AccessInputMetaInjection implements StepMetaInjectionInterface {
  ...
  public void injectStepMetadataEntries(List<StepInjectionMetaEntry> all) throws KettleException {
    ...
    for (StepInjectionMetaEntry lookFields : all) {
            ...
            if (fieldEntry == Entry.FIELD) {
              ...
              for (StepInjectionMetaEntry entry : entries) {
                ...
                if (metaEntry!=null) {
                  ...
                  case FIELD_COLUMN: field.setColumn(value); break;
      ...
      case ROW_NUMBER_BY_FILE: meta.setResetRowNumber("Y".equalsIgnoreCase(lookValue)); break;
      ...
      case ACCEPT_FILE_NAMES: meta.setFileField("Y".equalsIgnoreCase(lookValue)); break;
      case ACCEPT_FILE_FIELD: meta.setDynamicFilenameField(lookValue); break;
  ...
  private enum Entry {
    ...
    FILENAME(FILENAME_LINE, ValueMetaInterface.TYPE_STRING, "The filename or directory"),
    FILEMASK(FILENAME_LINE, ValueMetaInterface.TYPE_STRING, "The file mask (regex)"),
    EXCLUDE_FILEMASK(FILENAME_LINE, ValueMetaInterface.TYPE_STRING, "The mask for the files to exclude (regex)"),
    FILE_REQUIRED(FILENAME_LINE, ValueMetaInterface.TYPE_STRING, "Is this a required file (Y/N)"),
    INCLUDE_SUBFOLDERS(FILENAME_LINE, ValueMetaInterface.TYPE_STRING, "Include sub-folders when searching files? (Y/N)"),
    ...
    FIELD_NAME(FIELD, ValueMetaInterface.TYPE_STRING, "Field name"),
    FIELD_COLUMN(FIELD, ValueMetaInterface.TYPE_STRING, "Field source column name"),
    FIELD_TYPE(FIELD, ValueMetaInterface.TYPE_STRING, "Field data type"),
    FIELD_LENGTH(FIELD, ValueMetaInterface.TYPE_STRING, "Field length"),
    FIELD_PRECISION(FIELD, ValueMetaInterface.TYPE_STRING, "Field precision"),
    FIELD_TRIM_TYPE(FIELD, ValueMetaInterface.TYPE_STRING, "Field trim type (none, left, right, both)"),
    FIELD_FORMAT(FIELD, ValueMetaInterface.TYPE_STRING, "Field conversion format"),
    FIELD_CURRENCY(FIELD, ValueMetaInterface.TYPE_STRING, "Field currency symbol"),
    FIELD_DECIMAL(FIELD, ValueMetaInterface.TYPE_STRING, "Field decimal symbol"),
    FIELD_GROUP(FIELD, ValueMetaInterface.TYPE_STRING, "Field group symbol"),
    FIELD_REPEAT(FIELD, ValueMetaInterface.TYPE_STRING, "Field repeat (Y/N)"),
