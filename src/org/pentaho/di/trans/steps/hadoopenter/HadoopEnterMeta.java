...
@Step(id = "HadoopEnterPlugin", image = "MRI.png", name = "Map/Reduce Input", description = "Enter a Hadoop Mapper or Reducer transformation", categoryDescription = "Big Data")
