...
public class JobEntryCategory
{
	...
	public static final JobEntryCategory FILE_TRANSFERT      = new JobEntryCategory(Messages.getString("JobCategory.Category.FileTransfert"));
	...
	public static final int CATEGORY_FILE_TRANSFERT  =  8;
	
	public static final JobEntryCategory[] STANDARD_CATEGORIES = new JobEntryCategory[] { 
			GENERAL, MAIL, FILE_MANAGEMENT, CONDITIONS, SCRIPTING, BULK_LOADING, XML, REPOSITORY,FILE_TRANSFERT,
		};
