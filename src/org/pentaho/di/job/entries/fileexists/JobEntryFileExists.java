...
public class JobEntryFileExists extends JobEntryBase implements Cloneable, JobEntryInterface {
  ...
  public void loadXML( Node entrynode, List<DatabaseMeta> databases, List<SlaveServer> slaveServers, Repository rep )
    ...
    try {
      ...
      throw new KettleXMLException( BaseMessages.getString( PKG,
          "JobEntryFileExists.ERROR_0001_Cannot_Load_Job_Entry_From_Xml_Node" ), xe ); //$NON-NLS-1$
    }
  }
  ...
  public void loadRep( Repository rep, ObjectId id_jobentry, List<DatabaseMeta> databases,
    ...
    try {
      ...
      throw new KettleException( BaseMessages.getString( PKG,
          "JobEntryFileExists.ERROR_0002_Cannot_Load_Job_From_Repository", id_jobentry ), dbe ); //$NON-NLS-1$
    }
  }
  ...
  public void saveRep( Repository rep, ObjectId id_job ) throws KettleException {
    try {
      ...
      throw new KettleException( BaseMessages.getString( PKG,
          "JobEntryFileExists.ERROR_0003_Cannot_Save_Job_Entry", id_job ), dbe ); //$NON-NLS-1$
    }
  }
