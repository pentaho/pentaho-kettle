...
public class JobEntrySendNagiosPassiveCheck extends JobEntryBase implements Cloneable, JobEntryInterface
{
     ...
     */
    static private int DEFAULT_RESPONSE_TIME_OUT = 10000;    // ms
    
    /**
     * Default connection responseTimeOut to 5000 milliseconds
     */
    static public int DEFAULT_CONNECTION_TIME_OUT = 5000;    // ms
 ...
 public static int getLevelByDesc(String tt) {
	...
	public void saveRep(Repository rep, ObjectId id_job) throws KettleException
	{
		...
		{
			throw new KettleException("Unable to save job entry of type 'SendNagiosPassiveCheck' to the repository for id_job="+id_job, dbe);
		}
	}
	...
	/**
	 * @param user The password to set.
	 */
