...
public class XulHelper
{
	...
	public static MenuBar createMenuBar(String menuFile, Shell shell,Messages xulMessages) throws KettleException
	{
		...
		{
			throw new KettleException(org.pentaho.di.spoon.Messages.getString("Spoon.Exception.XULFileNotFound.Message", menuFile));
		}
	...
	private static URL getAndValidate(String url) throws KettleException, IOException
	{
		...
		if (resource == null)
			throw new KettleException(org.pentaho.di.spoon.Messages.getString("Spoon.Exception.XULFileNotFound.Message", url));
