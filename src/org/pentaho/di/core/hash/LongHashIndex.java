...
public final class LongHashIndex
{
    ...
    public Long insert(Long key, Long value)
    {
        ...
        for (Entry e = table[i]; e != null; e = e.next)
        {
            ...
            if (e.hash == hash && e.key.longValue() == key.longValue()) return e.value;
        }
    ...
    public Long putAgain(Long key, Long value)
    {
        ...
        for (Entry e = table[i]; e != null; e = e.next)
        {
            ...
            if (e.hash == hash && e.key.longValue() == key.longValue())
            {
                Long old = e.value;
                e.value = value;
                return old;
    ...
    public void remove(Long key)
    {
        ...
        {
            Entry next = e.next;
            if (e.key.longValue() == key.longValue())
            {
                size--;
                if (prev == e)
                    table[i] = next;
    ...
    private final static class Entry
    {
        ...
        public boolean equals(Object obj)
        {
            ...
            return key.longValue() == e.key.longValue();
        }
    }
