...
public final class ByteArrayHashIndex {
     ...
     */
    public ByteArrayHashIndex(int initialCapacity, float loadFactor, RowMetaInterface keyMeta) {
     ...
     * @throws IllegalArgumentException if the initial capacity is negative.
     */
    public ByteArrayHashIndex(int initialCapacity, RowMetaInterface keyMeta) {
     ...
     */
    public ByteArrayHashIndex(RowMetaInterface keyMeta) {
        this.keyMeta = keyMeta;
     ...
     * @throws KettleValueException in case of a value conversion error
     */
    public byte[] insert(byte[] key, byte[] value) throws KettleValueException {
        int hash = generateHashCode(key, keyMeta);
     ...
     * @throws KettleValueException in case of a value conversion error
     */
    public byte[] putAgain(byte[] key, byte[] value) throws KettleValueException {
        int hash = generateHashCode(key, keyMeta);
        int i = hash & (table.length-1);
     ...
     * @throws KettleValueException in case of a value conversion error
     */
    public void remove(byte[] key) throws KettleValueException {
        int hash = generateHashCode(key, keyMeta);
        int i = hash & (table.length-1);
    ...
    public static int generateHashCode(byte[] key, RowMetaInterface metadata) throws KettleValueException
    {
        return metadata.hashCode( RowMeta.getRow(metadata, key) );
    }
