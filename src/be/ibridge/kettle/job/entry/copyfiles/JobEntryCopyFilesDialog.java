...
public class JobEntryCopyFilesDialog extends Dialog implements JobEntryDialogInterface
{

	private static final String[] FILETYPES = new String[] 
		{
			Messages.getString("JobCopyFiles.Filetype.All") };
	...
	public JobEntryCopyFilesDialog(Shell parent, JobEntryCopyFiles jobEntry, JobMeta jobMeta)
	{
		...
		if (this.jobEntry.getName() == null) 
			this.jobEntry.setName(Messages.getString("JobCopyFiles.Name.Default"));
	}
	...
	public JobEntryInterface open()
	{
		...
		(
			new SelectionAdapter()
			{
				public void widgetSelected(SelectionEvent e)
				{
					...
					{
						ddialog.setFilterPath(StringUtil.environmentSubstitute(wSourceFileFolder.getText()) );
					}
		...
		wSourceFileFolder=new TextVar(wGeneralComp, SWT.SINGLE | SWT.LEFT | SWT.BORDER);
		...
		wSourceFileFolder.addModifyListener(new ModifyListener()
		{
			public void modifyText(ModifyEvent e)
			{
				wSourceFileFolder.setToolTipText(StringUtil.environmentSubstitute(wSourceFileFolder.getText() ) );
			}
		}
			);
			...
			new SelectionAdapter()
		{
			public void widgetSelected(SelectionEvent e)
			{
				...
				if (wSourceFileFolder.getText()!=null)
				{
					dialog.setFileName(StringUtil.environmentSubstitute(wSourceFileFolder.getText()) );
				}
		...
		(
			new SelectionAdapter()
			{
				public void widgetSelected(SelectionEvent e)
				{
					...
					{
						ddialog.setFilterPath(StringUtil.environmentSubstitute(wDestinationFileFolder.getText()) );
					}
		...
		wDestinationFileFolder = new TextVar(wGeneralComp, SWT.SINGLE | SWT.LEFT | SWT.BORDER); 
			...
			new SelectionAdapter()
		{
			public void widgetSelected(SelectionEvent e)
			{
				...
				if (wDestinationFileFolder.getText()!=null)
				{
					dialog.setFileName(StringUtil.environmentSubstitute(wDestinationFileFolder.getText()) );
				}
				dialog.setFilterNames(FILETYPES);
				if (dialog.open()!=null)
				{
		...
		wWildcard = new TextVar(wGeneralComp, SWT.SINGLE | SWT.LEFT | SWT.BORDER);
		...
		wFields = new TableView(wGeneralComp, SWT.BORDER | SWT.FULL_SELECTION | SWT.MULTI, colinf,	FieldsRows, lsMod, props);
