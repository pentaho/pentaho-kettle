...
public class XMLInputPathFieldPosition implements Cloneable
{
     ...
     */
    public XMLInputPathFieldPosition(String name, int type)
    {
        this.name      = name;
        this.type      = type;
        this.elementNr = 1;
     ...
     */
    public XMLInputPathFieldPosition(String name, int type, int elementNr)
    {
        this.name = name;
        this.type = type;
     ...
     * @param encoded
     */
    public XMLInputPathFieldPosition(String encoded) throws KettleValueException
    {
        int equalIndex = encoded.indexOf("=");
        if (equalIndex<0)
        {
            throw new KettleValueException(Messages.getString("XMLInputPathFieldPosition.Exception.InvalidXMLFieldPosition", encoded));
        }
        ...
        {
            throw new KettleValueException(Messages.getString("XMLInputPathFieldPosition.Exception.WrongPositionType", positionType));
        }
     ...
     * @param path An ArrayList of XMLInputPathFieldPosition
    ...
    public static final String encodePath(ArrayList path)
    {
        ...
        {
            XMLInputPathFieldPosition pos = (XMLInputPathFieldPosition)path.get(p); 
            String elementName = pos.toString();
            if (p>0) encoded+=XMLInputPathField.POSITION_MARKER;
            encoded+=elementName;
        }
