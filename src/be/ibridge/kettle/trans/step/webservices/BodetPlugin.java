 ...
 *
 */
public class BodetPlugin extends BaseStep implements StepInterface
{
	private BodetPluginData data;
	...
	public BodetPlugin(StepMeta aStepMeta, StepDataInterface aStepData, int value, TransMeta aTransMeta, Trans aTrans) 
	{
...
//	    }
	...
	{
		meta=(BodetPluginMeta)smi;
		data=(BodetPluginData)sdi;
