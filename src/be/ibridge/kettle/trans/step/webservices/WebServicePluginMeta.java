...
import be.ibridge.kettle.trans.step.webservices.ui.WebServicePluginDialog;
import be.ibridge.kettle.trans.step.webservices.wsdl.WSDLParameter;

public class WebServicePluginMeta extends BaseStepMeta implements StepMetaInterface
{
    ...
    public WebServicePluginMeta(Node stepnode, ArrayList databases, Hashtable counters) throws KettleXMLException
    {
        this();
        loadXML(stepnode, databases, counters);
    }

    public WebServicePluginMeta(Repository rep, long id_step, ArrayList databases, Hashtable counters) throws KettleException
    {
        this();
    ...
    public StepDialogInterface getDialog(Shell shell, StepMetaInterface meta, TransMeta transMeta, String name)
    {
        ...
        return new WebServicePluginDialog(shell, (BaseStepMeta) meta, transMeta, name);
    }

    public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta, Trans disp)
    {
        return new WebServicePlugin(stepMeta, stepDataInterface, cnr, transMeta, disp);
    }

    public StepDataInterface getStepData()
    {
        return new WebServicePluginData();
    }
