...
public class WebServicePluginDialog extends BaseStepDialog implements StepDialogInterface
{
...
//		}
	...
	*/
	...
	public WebServicePluginDialog(Shell aShell, BaseStepMeta in, TransMeta transMeta, String sname) {
		super(aShell, in, transMeta, sname);
		
		meta = (WebServicePluginMeta)in;
