...
final class WsdlUtils {
     ...
     */
    protected static HashSet getSOAPHeaders(Binding binding, String operationName) {
        ...
        HashSet headerSet = new HashSet(headers.size());
        for (Iterator itr = headers.iterator(); itr.hasNext();) {
            headerSet.add(((SOAPHeader) itr.next()).getPart());
        }
    ...
    protected static ExtensibilityElement findExtensibilityElement(ElementExtensible extensibleElement,
        ...
        if (extensibilityElements != null) {
            for (Iterator itr = extensibilityElements.iterator(); itr.hasNext();) {
                ExtensibilityElement element = (ExtensibilityElement) itr.next();
     ...
     */
    protected static List findExtensibilityElements(ElementExtensible extensibleElement,
                                                                          String elementType) {
