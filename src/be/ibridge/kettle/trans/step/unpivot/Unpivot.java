...
public class Unpivot extends BaseStep implements StepInterface
{
	...
	private void buildResult(Row inputRow)
    {
        ...
        inputRow.addRow(data.targetResult);
    }
	...
	private void unPivot(Row r) throws KettleValueException
	{
        ...
        if (keyNr!=null)
        {
            ...
            data.targetResult.getValue(idx).setValue(targetValue); // Overwrite the default.
        }
	}
