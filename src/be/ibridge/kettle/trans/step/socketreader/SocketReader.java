        ...
        try
        {
            ...
            if (first)
            {
                ...
                try
                {
                    ...
                    data.outputStream = new DataOutputStream(new BufferedOutputStream(data.socket.getOutputStream(), 10000));
                    // new GZIPInputStream(
                    data.inputStream  = new DataInputStream(new BufferedInputStream(data.socket.getInputStream(), 10000));
                }
                catch(Exception e)
                {
