        ...
        try
        {
            ...
            if (first)
            {
                ...
                try
                {
                    ...
                    data.outputStream = new DataOutputStream(new GZIPOutputStream(new BufferedOutputStream(data.socket.getOutputStream(), 10000)));
                    data.inputStream  = new DataInputStream(new GZIPInputStream(new BufferedInputStream(data.socket.getInputStream(), 10000)));
                }
                catch(Exception e)
                {
