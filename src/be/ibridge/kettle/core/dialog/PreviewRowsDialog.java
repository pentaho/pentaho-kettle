...
public class PreviewRowsDialog extends Dialog
{
    ...
    /**
     * @deprecated Use CT without the <i>log</i> and <i>props</i> parameter
     */
    public PreviewRowsDialog(Shell parent, int style, LogWriter log, Props props, String stepName, List rowBuffer)
    {
