...
public class HypersonicDatabaseMeta extends BaseDatabaseMeta implements DatabaseInterface
{
	 ...
	 * 
	 */
	public HypersonicDatabaseMeta(String name, String access, String host, String db, int port, String user, String pass)
	{
	...
	public String getURL()
	{
		...
		{
			return "jdbc:hsqldb:hsqldb://"+getHostname()+":"+getDatabasePortNumber();
		}
	}
