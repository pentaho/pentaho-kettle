...
public class GUIResource
{
	...
	private void loadStepImages()
	{
		...
		for (int i = 0; i < steps.length; i++)
		{
			...
			if (steps[i].isNative())
			{
				...
				try
				{
					image = ImageUtil.getImage(display,filename);//new Image(display, getClass().getResourceAsStream(filename));
				} catch (Exception e)
				{
					log.logError("Kettle",
	...
	private void loadCommonImages()
	{
		...
		//
		imageSpoonGraph = ImageUtil.makeImageTransparent(display, ImageUtil.getImage(display,
				"spoongraph.png"), new RGB(255, 255, 255));
		imageJobGraph = ImageUtil.makeImageTransparent(display, ImageUtil.getImage(display, "chefgraph.png"),
				new RGB(255, 255, 255));
		imageLogoSmall = ImageUtil.makeImageTransparent(display, ImageUtil.getImage(display,
				"kettle_logo_small.png"), new RGB(255, 255, 255));
		imageArrow = ImageUtil.makeImageTransparent(display, ImageUtil.getImage(display, "arrow.png"),
				new RGB(255, 255, 255));
		imageBanner = ImageUtil.makeImageTransparent(display, ImageUtil.getImage(display, "bg_banner.png"),
				new RGB(255, 255, 255));
