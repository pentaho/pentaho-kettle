...
public class Spoon implements AddUndoPositionInterface, TabListener, SpoonInterface, OverwritePrompter, PDIObserver, LifeEventHandler, XulEventSource, XulEventHandler {
  ...
  public boolean saveFile() throws KettleException{
	...
	public boolean saveToFile(EngineMetaInterface meta) throws KettleException {
		...
		if (log.isDetailed())
			log.logDetailed(BaseMessages.getString(PKG, "Spoon.Log.SaveToFileOrRepository"));// "Save to file or repository..."
	...
	public boolean saveToRepository(EngineMetaInterface meta, boolean ask_name) throws KettleException {
		...
		if (log.isDetailed())
			log.logDetailed(BaseMessages.getString(PKG, "Spoon.Log.SaveToRepository"));// "Save to repository..."
		if (rep != null) {
			boolean answer = true;
  ...
  public boolean saveFileAs() throws KettleException{
	...
	public void refreshTree() {
		 ...
		 * delegates.jobs.getJobList(); Collections.sort(jobs); JobMeta[]
		 * jobMetas = jobs.toArray(new JobMeta[jobs.size()]);
		 */
