...
public class TransGridDelegate extends SpoonDelegate implements XulEventHandler {
  ...
  public void addTransGrid() {
    ...
    ColumnInfo[] colinf = new ColumnInfo[] { new ColumnInfo(Messages.getString("TransLog.Column.Stepname"), ColumnInfo.COLUMN_TYPE_TEXT, false, true), //$NON-NLS-1$
  ...
  public void showHideInactive() {
    ...
    if (onlyActiveButton != null) {
      ...
      if (hideInactiveSteps) {
        ...
        ((ToolItem) onlyActiveButton.getManagedObject()).setImage(GUIResource.getInstance().getImageShowInactive());
      }
    }
  }
