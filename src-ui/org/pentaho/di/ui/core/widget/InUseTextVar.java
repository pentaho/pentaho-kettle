 ...
 * On top of that we show an "In Use" image to the left if there is content in the text field.
 * 
 * @author Matt
 * @since 25-FEB-2009
 */
public class InUseTextVar extends Composite {
  private String toolTipText;

  // private static final PropsUI props = PropsUI.getInstance();

  private ControlDecoration variableControlDecoration;
  ...
  public InUseTextVar(VariableSpace space, Composite composite, int flags) {
    this(space, composite, flags, null, null, null);
  }

  public InUseTextVar(VariableSpace space, Composite composite, int flags, String toolTipText) {
