...
public class NamedConfiguration extends SharedObjectBase implements Cloneable, XMLInterface, SharedObjectInterface,
        ...
        for ( Node groupnode : groupnodes ) {
          ...
          if ( propertiesnode != null ) {
            ...
            for ( Node propertyNode : propertyNodes ) {
              String name = XMLHandler.getTagValue( propertyNode, "name" );
              String value = XMLHandler.getTagValue( propertyNode, "value" );
              ...
              Property property = new Property( name, value, uiType, type, defaultValues );
  ...
  public String getXML() {
    ...
    for ( Group group : groups ) {
      ...
      for ( Property property : group.getProperties() ) {
        ...
        xml.append( "            ").append( XMLHandler.addTagValue( "name", property.getName(), true ) );
        xml.append( "            ").append( XMLHandler.addTagValue( "value", property.getValue().toString(), true ) );
  ...
  public void replaceMeta( NamedConfiguration config ) {
    ...
    for ( Group group : config.groups ) {
      ...
      for ( Property property : group.getProperties() ) {
        Property newProperty = new Property( property.getName(), property.getValue(), property.getUiType(), property.getType(), property.getDefaultValues() );
