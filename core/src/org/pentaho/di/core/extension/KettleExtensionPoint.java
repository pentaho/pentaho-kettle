...
public enum KettleExtensionPoint {
  ...
  JobStart( "JobStart", "A job starts" ), JobFinish( "JobFinish", "A job finishes" ), JobBeforeJobEntryExecution(
      ...
      "TransPainterJobEntry", "Draw additional information on top of a job entry copy icon" ), JobGraphJobEntrySetMenu(
      "JobGraphJobEntrySetMenu", "Manipulate the menu on right click on a job entry" ),
