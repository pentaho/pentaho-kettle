 ...
 * twice. Queries are often launched to the databases to get information on
 * tables etc.
 * 
 * @author Matt
 * @since 15-01-04
...
public class DBCache {
   ...
   * 
   * @param dbname
   *          The name of the database for which we want to clear the cache or
   *          null if we want to clear it all.
   */
