...
public class Metrics implements MetricsInterface {
  ...
  public static Metrics METRIC_DATABASE_GET_ROW_COUNT = new Metrics(MetricsSnapshotType.COUNT, "METRIC_DATABASE_GET_ROW_COUNT", "Get row from DB (count)");
  ...
  public static Metrics METRIC_DATABASE_GET_ROW_MIN_TIME = new Metrics(MetricsSnapshotType.MIN, "METRIC_DATABASE_GET_ROW_MIN_TIME", "Get row from DB (min time)");
  public static Metrics METRIC_DATABASE_GET_ROW_MAX_TIME = new Metrics(MetricsSnapshotType.MAX, "METRIC_DATABASE_GET_ROW_MAX_TIME", "Get row from DB (max time)");
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof MetricsInterface)) return false;
