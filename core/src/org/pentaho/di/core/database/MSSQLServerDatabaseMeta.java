...
public class MSSQLServerDatabaseMeta extends BaseDatabaseMeta implements DatabaseInterface {
  ...
  public String[] getReservedWords() {
    return new String[] {
        /*
         * Transact-SQL Reference: Reserved Keywords Includes future keywords: could be reserved in future releases of
         * SQL Server as new features are implemented. REMARK: When SET QUOTED_IDENTIFIER is ON (default), identifiers
         * can be delimited by double quotation marks, and literals must be delimited by single quotation marks. When
         * SET QUOTED_IDENTIFIER is OFF, identifiers cannot be quoted and must follow all Transact-SQL rules for
         * identifiers.
         */
