 ...
 *
 */
public class KettleXMLException extends KettleException {
  public static final long serialVersionUID = 0x8D8EA0264F7A1C19L;

  /**
   * Constructs a new throwable with null as its detail message.
   */
  public KettleXMLException() {
    super();
  }
   ...
   */
  public KettleXMLException( String message ) {
    super( message );
  }
   ...
   */
  public KettleXMLException( Throwable cause ) {
    super( cause );
  }
   ...
   *          indicates that the cause is nonexistent or unknown.)
   */
  public KettleXMLException( String message, Throwable cause ) {
    super( message, cause );
  }
