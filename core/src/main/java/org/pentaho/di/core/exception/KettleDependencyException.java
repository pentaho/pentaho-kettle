 ...
 *
 */
public class KettleDependencyException extends KettleDatabaseException {
  public static final long serialVersionUID = 0x8D8EA0264F7A1C10L;

  /**
   * Constructs a new throwable with null as its detail message.
   */
  public KettleDependencyException() {
    super();
  }
   ...
   */
  public KettleDependencyException( String message ) {
    super( message );
  }
   ...
   */
  public KettleDependencyException( Throwable cause ) {
    super( cause );
  }
   ...
   *          indicates that the cause is nonexistent or unknown.)
   */
  public KettleDependencyException( String message, Throwable cause ) {
    super( message, cause );
  }
}
