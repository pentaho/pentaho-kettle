 ...
 *
 */
public class KettleTransException extends KettleException {
  public static final long serialVersionUID = 0x8D8EA0264F7A1C17L;

  /**
   * Constructs a new throwable with null as its detail message.
   */
  public KettleTransException() {
    super();
  }
   ...
   */
  public KettleTransException( String message ) {
    super( message );
  }
   ...
   */
  public KettleTransException( Throwable cause ) {
    super( cause );
  }
   ...
   *          indicates that the cause is nonexistent or unknown.)
   */
  public KettleTransException( String message, Throwable cause ) {
    super( message, cause );
  }
