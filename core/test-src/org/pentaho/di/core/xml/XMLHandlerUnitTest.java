...
public class XMLHandlerUnitTest {
  ...
  public void testEscapingXmlBagCharacters() throws Exception {
    String testString = "\"\'<&>tag test@#$% )(+!@#?//| <&>";
    String expectedStrAfterConversion = "&#34;&#39;&lt;&amp;&gt;tag test@#$% )(+!@#?//| &lt;&amp;&gt;";
    String result = XMLHandler.addTagValue( testString, testString, false, testString, testString );
    String expected = "<" + expectedStrAfterConversion + " " + expectedStrAfterConversion
     + "=\"" + expectedStrAfterConversion + "\"" + " >" + expectedStrAfterConversion + "</" + expectedStrAfterConversion + ">";
    assertEquals( expected, result );
  }
