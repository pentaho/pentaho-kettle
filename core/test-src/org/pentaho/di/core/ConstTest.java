...
public class ConstTest {
  ...
  public void testToDouble() {
    assertEquals( 123.45, Const.toDouble( "123.45", -12.34 ) );
    assertEquals( -12.34, Const.toDouble( "123asd", -12.34 ) );
  }
  ...
  public void testToDate() {
    ...
    assertEquals( expected, Const.toDate( "2015/11/11 17:41:54.241", def ) );
  ...
  public void testIndexsOfStrings() {
    assertArrayEquals( new int[] { 2, 1, -1 }, Const.indexsOfStrings( new String[] { "foo", "bar", "qux" },
        new String[] { "baz", "bar", "foo" } ) );
  }

  @Test
  public void testIndexsOfFoundStrings() {
    assertArrayEquals( new int[] { 2, 1 }, Const.indexsOfFoundStrings( new String[] { "qux", "foo", "bar" },
        new String[] { "baz", "bar", "foo" } ) );
  }
  ...
  public void testGetDistinctStrings() {
    ...
    assertArrayEquals( new String[] { "bar", "foo" }, Const.getDistinctStrings( new String[] { "foo", "bar", "foo",
      "bar" } ) );
  }
  ...
  public void testGetPercentageFreeMemory() {
    assertTrue( Const.getPercentageFreeMemory() < 100 );
  }
