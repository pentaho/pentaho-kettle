...
public class JobEntryDeleteFileDialog extends Dialog implements JobEntryDialogInterface
{
   private static final String[] FILETYPES = new String[] {
	...
	public JobEntryInterface open()
	{
		...
		shell.setText(Messages.getString("JobDeleteFile.Title"));
		...
		wlName.setText(Messages.getString("JobDeleteFile.Name.Label"));
		...
		wlFilename.setText(Messages.getString("JobDeleteFile.Filename.Label"));
        ...
        wlAbortExists.setText(Messages.getString("JobDeleteFile.FailIfExists.Label"));
        ...
        wAbortExists.setToolTipText(Messages.getString("JobDeleteFile.FailIfExists.Tooltip"));
