...
public class LDIFInputField implements Cloneable
{
	...
	private LDIFInputFieldPosition[] fieldPosition;
	...
	public LDIFInputField(String fieldname, LDIFInputFieldPosition[] LDIFInputFieldPositions)
	{
		this.name             = fieldname;
		this.attribut        = "";
		this.fieldPosition   = LDIFInputFieldPositions;
		this.length         = -1;
    ...
    public Object clone()
	{
		try
		{
            ...
            {
                retval.setFieldPosition( new LDIFInputFieldPosition[fieldPosition.length] );
                for (int i=0;i<fieldPosition.length;i++)
                {
                    retval.getFieldPosition()[i] = (LDIFInputFieldPosition)fieldPosition[i].clone();
                }
            }
     ...
     */
    public LDIFInputFieldPosition[] getFieldPosition()
    {
        return fieldPosition;
    }

    /**
     * @param LDIFInputFieldPositions The LDIFInputFieldPositions to set.
     */
    public void setFieldPosition(LDIFInputFieldPosition[] LDIFInputFieldPositions)
    {
        this.fieldPosition = LDIFInputFieldPositions;
    }
    ...
    public void setFieldPosition(String encoded) throws KettleException
    {
        try
        {
            ...
            fieldPosition = new LDIFInputFieldPosition[codes.length];
            for (int i=0;i<codes.length;i++)
            {
                fieldPosition[i] = new LDIFInputFieldPosition(codes[i]);
            }
        }
        catch(Exception e)
        {
