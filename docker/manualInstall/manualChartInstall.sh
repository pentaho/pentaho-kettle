...
helm chart save ./webspoon* ldl-dev-r2d2-c7-registry.dogfood.trylumada.com/webspoon:1.1.1
# must rev version to match solutionPackage.yaml and Chart.yaml
helm chart push ldl-dev-r2d2-c7-registry.dogfood.trylumada.com/webspoon:1.1.1
