...
public class TypeConverterFactoryTest {
  ...
  public void getWritableForKettleType() {
    ...
    assertEquals(NullWritable.class, TypeConverterFactory.getWritableForKettleType(null));
  ...
  public void getConverter() throws TypeConversionException {
    ...
    try {
      ...
      assertTrue("Unexpected exception: " + ex.getMessage(), ex.getMessage().contains("No converter found to convert"));
    }
