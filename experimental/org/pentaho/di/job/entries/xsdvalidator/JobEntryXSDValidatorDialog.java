 ...
 * @since  30-04-2007
 */
public class JobEntryXSDValidatorDialog extends Dialog implements JobEntryDialogInterface
{
   private static final String[] FILETYPES_XML = new String[] {
	...
	public JobEntryXSDValidatorDialog(Shell parent, JobEntryXSDValidator jobEntry, JobMeta jobMeta)
	{
