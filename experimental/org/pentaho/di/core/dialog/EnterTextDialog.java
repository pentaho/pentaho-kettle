...
public class EnterTextDialog extends Dialog
{
     ...
     */
    public EnterTextDialog(Shell parent, Props props, String title, String message, String description, boolean fixed)
    {
     ...
     * @deprecated Use version without <i>props</i> parameter
     */
    public EnterTextDialog(Shell parent, Props props, String title, String message, String description)
    {
